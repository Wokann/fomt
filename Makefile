...
REGION_TEXT_OBJS := $(REGION_TEXT_ORDINARY_OBJS) $(HARVEST_SPRITE_MINIGAME_TEXT_OBJS) $(NEW_GAME_PRESET_TEXT_OBJ) $(FRISBEE_SCOREBOARD_TEXT_OBJ)
REGION_TEXT_DEPS := $(REGION_TEXT_ORDINARY_DEPS) $(HARVEST_SPRITE_MINIGAME_TEXT_DEPS) $(NEW_GAME_PRESET_TEXT_DEP) $(FRISBEE_SCOREBOARD_TEXT_DEP)
