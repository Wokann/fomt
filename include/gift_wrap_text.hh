...
extern char const gText_GiftWrap_No[];
extern char const gText_GiftWrap_DogWarning[];
extern char const gText_GiftWrap_Tools[];
extern char const gText_GiftWrap_Items[];
