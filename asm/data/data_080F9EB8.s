...
jp_static_data_after_font:
    ...
    @ The preceding 0xC00 bytes are two recovered 128-entry ToneData tables.
    @ This remaining 0x254-byte tail is still raw.
    .section .rodata.m4a_static_data_after_voice_groups
    .global gUnk_0813BAA4
gUnk_0813BAA4:
    .incbin "baserom_jp.gba", 0x13BAA4, (0x13BCF8 - 0x13BAA4)

    @ CGB waveform labels referenced by the recovered ToneData tables.
    .global gM4aCgbWave_000
    .set gM4aCgbWave_000, gUnk_0813BAA4 + 0x54
    .global gM4aCgbWave_001
    .set gM4aCgbWave_001, gUnk_0813BAA4 + 0x64
    .global gM4aCgbWave_002
    .set gM4aCgbWave_002, gUnk_0813BAA4 + 0x84
    .global gM4aCgbWave_003
    .set gM4aCgbWave_003, gUnk_0813BAA4 + 0x94
    .global gM4aCgbWave_004
    .set gM4aCgbWave_004, gUnk_0813BAA4 + 0xA4
    .global gM4aCgbWave_005
    .set gM4aCgbWave_005, gUnk_0813BAA4 + 0xC4
    .global gM4aCgbWave_006
    .set gM4aCgbWave_006, gUnk_0813BAA4 + 0x234
    .global gM4aCgbWave_007
    .set gM4aCgbWave_007, gUnk_0813BAA4 + 0x244
...
us_static_data_after_font:
    ...
    @ This remaining 0x254-byte tail is still raw.
    .section .rodata.m4a_static_data_after_voice_groups
    .global gUnk_0813A960
gUnk_0813A960:
    .incbin "baserom_us.gba", 0x13A960, (0x13ABB4 - 0x13A960)

    @ CGB waveform labels referenced by the recovered ToneData tables.
    .global gM4aCgbWave_000
    .set gM4aCgbWave_000, gUnk_0813A960 + 0x54
    .global gM4aCgbWave_001
    .set gM4aCgbWave_001, gUnk_0813A960 + 0x64
    .global gM4aCgbWave_002
    .set gM4aCgbWave_002, gUnk_0813A960 + 0x84
    .global gM4aCgbWave_003
    .set gM4aCgbWave_003, gUnk_0813A960 + 0x94
    .global gM4aCgbWave_004
    .set gM4aCgbWave_004, gUnk_0813A960 + 0xA4
    .global gM4aCgbWave_005
    .set gM4aCgbWave_005, gUnk_0813A960 + 0xC4
    .global gM4aCgbWave_006
    .set gM4aCgbWave_006, gUnk_0813A960 + 0x234
    .global gM4aCgbWave_007
    .set gM4aCgbWave_007, gUnk_0813A960 + 0x244
    .endif
