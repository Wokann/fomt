...
.L0800755E:
    ...
    pop {r1}
    bx r1
    thumb_func_start func_08007564
func_08007564:
    ldr r0, .L08007570
    ldr r0, [r0]
    adds r0, #0x48
    ...
    bx lr
    .align 2, 0
.L08007570: .4byte gUnk_03000404

    thumb_func_start func_08007574
func_08007574:
    movs r0, #0x10
    bx lr

    thumb_func_start func_08007578
func_08007578:
    push {r4, r5, r6, r7, lr}
    mov r7, sl
    mov r6, r9
...
.L080080E4:
    ...
    bx r0
    .align 2, 0
    thumb_func_start func_080080EC
func_080080EC:
    ldrb r0, [r0, #1]
    bx lr

    thumb_func_start func_080080F0
func_080080F0:
    ldrb r0, [r0]
    bx lr
...
.L0800815C:
    ...
    thumb_func_start func_08008190
func_08008190:
    push {r4, r5, r6, r7, lr}
    mov r7, sl
    mov r6, r9
...
.L08008614: .4byte 0x04000004
    thumb_func_start func_08008618
func_08008618:
    push {r4, r5, r6, lr}
    mov r6, r8
    push {r6}
    ...
    bx r1
    .align 2, 0
.L080086A4: .4byte vtable_unk_080E5B00
.L080086A8: .4byte 0x00000494
.L080086AC: .4byte vtable_unk_080E5BB4
.L080086B0: .4byte 0x000004A4
.L080086B4: .4byte vtable_unk_080E5BD8
.L080086B8: .4byte 0x04000004
...
.L08008770: .4byte vtable_unk_080E5AF0
    thumb_func_start func_08008774
func_08008774:
    push {r4, lr}
    sub sp, #0x10
    ldr r4, [r0]
    ...
    bx r0
    .align 2, 0
.L080087BC: .4byte 0x0000FF7F
.L080087C0: .4byte vtable_unk_080E5AF0
...
func_08008BE0: @ 0x08008BE0
    ...
    pop {r0}
    bx r0
    thumb_func_start func_08008BEC
func_08008BEC:
    push {lr}
    ldr r0, [r0]
    bl m4aMPlayContinue
...
func_08008BF8: @ 0x08008BF8
    ...
    pop {r0}
    bx r0
    thumb_func_start func_08008C08
func_08008C08:
    push {lr}
    lsls r1, r1, #0x10
    lsrs r1, r1, #0x10
    ...
    thumb_func_start func_08008C18
func_08008C18:
    push {lr}
    lsls r1, r1, #0x10
    lsrs r1, r1, #0x10
...
.L08008D58: .4byte gSongTable
    thumb_func_start func_08008D5C
func_08008D5C:
    lsls r0, r0, #0x10
    ldr r1, .L08008D6C
    lsrs r0, r0, #0xd
    ...
    bx lr
    .align 2, 0
.L08008D6C: .4byte gSongTable

    thumb_func_start func_08008D70
func_08008D70:
    lsls r0, r0, #0x10
    ldr r1, .L08008D80
    lsrs r0, r0, #0xd
...
func_08008DB8: @ 0x08008DB8
    ...
    bx r0
    .align 2, 0
    thumb_func_start func_08008DC8
func_08008DC8:
    push {lr}
    lsls r0, r0, #0x10
    lsrs r0, r0, #0x10
    ...
    thumb_func_start func_08008DD8
func_08008DD8:
    push {lr}
    lsls r0, r0, #0x10
    lsrs r0, r0, #0x10
...
func_08008DE8: @ 0x08008DE8
    ...
    bx r0
    .align 2, 0
    thumb_func_start func_08008DF4
func_08008DF4:
    push {lr}
    lsls r0, r0, #0x10
    lsrs r0, r0, #0x10
    ...
    thumb_func_start func_08008E04
func_08008E04:
    push {lr}
...
.L08009548:
    ...
    bx r1
    .align 2, 0
.L08009568: .4byte vtable_unk_080E5B80
...
.L08009710:
    ...
    bx r0
    .align 2, 0
.L08009738: .4byte 0x04000040
.L0800973C: .4byte 0x04000005
.L08009740: .4byte 0x04000014
...
.L08009A04:
    ...
    str r2, [r0, #0x14]
    bx lr
.L08009A24: .4byte vtable_unk_080E5BB4
.L08009A28: .4byte vtable_unk_080E5BD8
.L08009A2C:
    ldr r1, [r0]
    negs r0, r1
    orrs r0, r1
...
.L08009A38:
    ...
    str r1, [r0, #4]
    bx lr
.L08009A44: .4byte vtable_unk_080E5BE8
