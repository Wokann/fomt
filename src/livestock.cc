...
LivestockDayUpdateInfo const gChickenDayUpdateInfo SECTION(".rodata.livestock_day_update") = {
    40,
    70,
...
LivestockDayUpdateInfo const gCowDayUpdateInfo SECTION(".rodata.livestock_day_update") = {
    40,
    50,
...
LivestockDayUpdateInfo const gSheepDayUpdateInfo SECTION(".rodata.livestock_day_update") = {
    40,
    60,
