...
route now also covers `ui/scene_080bcfac/`, `ui/scene_080c160c/` (the last
loads its palette beginning at BG bank 1), and `ui/scene_080ae7d0/`.
Regenerate a reference set with:
