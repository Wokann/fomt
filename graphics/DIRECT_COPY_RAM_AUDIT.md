...
The current four-region FoMT assembly has eighteen such paths. Every recovered
...
| `func_080019D8` | `gUnk_0874E330`, `gUnk_084D4AC4` | `0x05000000`, `0x200` | Managed Intro Scene startup palette banks: the first is the non-JP shared physical source, and the second is its JP physical location. |
