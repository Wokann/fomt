...
- [Shared OAM resource `0873CEAC`](shared_resource_0873ceac/full/) — one
  complete indexed-PNG OAM source view with native descriptor layout.
- [Shared OAM resource `0873CF90`](shared_resource_0873cf90/full/) — four
  complete indexed-PNG OAM source views with native descriptor layout.
- [Shared OAM resource `0873D234`](shared_resource_0873d234/full/) — six
  complete indexed-PNG OAM source views with native descriptor layout.
- [Shared OAM resource `0873D5FC`](shared_resource_0873d5fc/full/) — one
  complete indexed-PNG OAM source view with native descriptor layout.
- [Shared OAM resource `0873DE44`](shared_resource_0873de44/full/) — one
  complete indexed-PNG OAM source view with native descriptor layout.
- [Shared OAM resource `0873E5B0`](shared_resource_0873e5b0/full/) — one
  complete indexed-PNG OAM source view with native descriptor layout.
- [Shared OAM resource `0873ED1C`](shared_resource_0873ed1c/full/) — ten
  complete indexed-PNG OAM source views with native descriptor layout.
- [Shared OAM resource `087401A4`](shared_resource_087401a4/full/) — four
  complete indexed-PNG OAM source views with native descriptor layout.
- [Shared OAM resource `08740454`](shared_resource_08740454/full/) — three
  complete indexed-PNG OAM source views with native descriptor layout.
- [Shared OAM resource `087405A0`](shared_resource_087405a0/full/) — one
  complete indexed-PNG OAM source view with native descriptor layout.
- [Shared OAM resource `08740908`](shared_resource_08740908/full/) — one
  complete indexed-PNG OAM source view with native descriptor layout.
- [Shared OAM resource `087409E4`](shared_resource_087409e4/full/) — four
  complete indexed-PNG OAM source views with native descriptor layout.
- [Shared OAM resource `0874EE38`](shared_resource_0874ee38/full/) — one
  complete indexed-PNG OAM source view with native descriptor layout.
- [Shared OAM resource `087506E0`](shared_resource_087506e0/full/) — four
  complete indexed-PNG OAM source views with native descriptor layout.
- [Shared OAM resource `0875352C`](shared_resource_0875352c/full/) — one
  complete indexed-PNG OAM source view with native descriptor layout.
- [Shared OAM resource `08753608`](shared_resource_08753608/full/) — one
  complete indexed-PNG OAM source view with native descriptor layout.
- [Shared OAM resource `087536E4`](shared_resource_087536e4/full/) — four
  complete indexed-PNG OAM source views with native descriptor layout.
- [Shared OAM resource `08755154`](shared_resource_08755154/full/) — one
  complete indexed-PNG OAM source view with native descriptor layout.
