...
| Direct `func_080B7164` UI-scene BG streams | `graphics/ui/scene_080b7164/shared/tiles.4bpp` and `layer_*.tilemap` | three native packed streams, patched back to original locations after link | Yes |
