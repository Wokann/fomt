...
| Overseas `func_08077810` BG and character streams | `graphics/ui/scene_08077810/shared/tiles.png`, `tiles_trailer.bin`, `layer_0.tilemap`, and `layer_1.tilemap` | editable Huffman-8/LZ3 character stream (351 4bpp tiles plus an explicit two-byte non-tile trailer), Huffman-4/LZ3 32-by-32 map, and Huffman-4/LZ0 32-by-20 map, included at the original US/EU/DE labels | Yes for JP/US/EU/DE: JP has no corresponding consumer and remains direct ROM data |
