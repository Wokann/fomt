...
| `gUnk_086FAA80` | `0x480BDC` | `0x6FAA80` | `0x6FAADC` | `0x481B1C` | `0x584` | 3, 9, 1, 36, 1, 0 | 9 | unmanaged, four-region identical |
...
Generated records: 51 (9 rebuilt, 33 unmanaged but four-region identical, 9 regionally different). Regenerate with:
