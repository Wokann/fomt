...
| `gUnk_086FAA80` | `0x480BDC` | `0x6FAA80` | `0x6FAADC` | `0x481B1C` | `0x584` | 3, 9, 1, 36, 1, 0 | 9 | rebuild, four-region shared: `graphics/shared_resource_086faa80/` |
| `gUnk_0871D51C` | `0x4A3678` | `0x71D51C` | `0x71D578` | `0x4A45B8` | `0x13BC` | 11, 33, 1, 132, 1, 0 | 47 | rebuild, region-local: `graphics/regional_resource_0871d51c/` |
| `gUnk_0871E7A8` | `0x4A4910` | `0x71E7A8` | `0x71E804` | `0x4A5974` | `0x504` | 8, 8, 1, 32, 1, 0 | 8 | rebuild, four-region shared: `graphics/ui/menu_resource_archive/` |
| `gUnk_0871ECAC` | `0x4A4E14` | `0x71ECAC` | `0x71ED08` | `0x4A5E78` | `0x128` | 1, 5, 1, 4, 1, 0 | 4 | rebuild, four-region shared: `graphics/shared_resource_0871ecac/` |
| `gUnk_0871EDD4` | `0x4A4F3C` | `0x71EDD4` | `0x71EE30` | `0x4A5FA0` | `0x12C` | 1, 5, 1, 4, 1, 0 | 5 | rebuild, four-region shared: `graphics/shared_resource_0871edd4/` |
...
| `gUnk_0873AE54` | `0x4C0FBC` | `0x73AE54` | `0x73AEB0` | `0x4C21C0` | `0x174` | 2, 2, 1, 8, 1, 0 | 2 | rebuild, four-region shared: `graphics/shared_resource_0873ae54/` |
...
| `gUnk_0873CCB4` | `0x4C2E1C` | `0x73CCB4` | `0x73CD10` | `0x4C4020` | `0x1F8` | 1, 2, 2, 12, 1, 0 | 2 | rebuild, four-region shared: `graphics/shared_resource_0873ccb4/` |
...
| `gUnk_0873ED1C` | `0x4C4E84` | `0x73ED1C` | `0x73ED78` | `0x4C6190` | `0x6AC` | 3, 10, 11, 41, 2, 0 | 11 | rebuild, four-region shared: `graphics/shared_resource_0873ed1c/` |
...
| `gUnk_087537D0` | `0x4D977C` | `0x7537D0` | `0x75382C` | `0x4DACEC` | `0xEA4` | 20, 40, 11, 73, 13, 0 | 40 | rebuild, four-region shared: `graphics/ui/farm_status/resource_archive/` |
...
Generated records: 51 (42 rebuilt shared, 5 rebuilt regional, 0 unmanaged but four-region identical, 4 regionally different). Regenerate with:
