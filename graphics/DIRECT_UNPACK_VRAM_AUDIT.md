...
| `230` | `086FB004`, `0875822C`, `0874A9C0` | The generic Huffman-8/LZ3 encoder strictly decodes. Seasonal winter has a verified one-pixel edit inside its `0x212C` slot using an explicitly scoped 512-candidate search; fixed-slot capability remains asset-specific rather than assumed for every `230` stream. |
