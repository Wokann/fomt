...
PROFILES = {
    ...
    "shared-0872ee78": ArchiveProfile(
        (4, 4, 1, 16, 1, 0, 4), (), "shared 0872EE78 resource"
    ),
    ...
    "regional-08728208": ArchiveProfile(
        (1, 3, 3, 4, 1, 0, 4), (), "regional 08728208 resource"
    ),
    ...
    "regional-0872de44-de": ArchiveProfile(
        (27, 27, 9, 110, 1, 0, 27), (), "regional 0872DE44 DE resource"
    ),
    ...
    "regional-0874f34c-us-eu": ArchiveProfile(
        (22, 22, 9, 134, 3, 0, 22), (), "regional 0874F34C US-EU resource"
    ),
    "regional-0874f34c-de": ArchiveProfile(
        (22, 22, 7, 140, 3, 0, 22), (), "regional 0874F34C DE resource"
    ),
    "regional-0875b444": ArchiveProfile(
        (6, 6, 1, 24, 1, 0, 6), (), "regional 0875B444 resource"
    ),
}
