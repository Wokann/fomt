...
mary_text_table
{
    const char gText_FamilyEvent_Ann_BabyBirthdayGooGoo[] =
        "Ga-ga.{Press}";
};

void EventScript_FamilyEvent_Ann_BabyBirthdayGooGoo(void)
{
    ...
    TalkMessage(gText_FamilyEvent_Ann_BabyBirthdayGooGoo);
    TalkClose();
