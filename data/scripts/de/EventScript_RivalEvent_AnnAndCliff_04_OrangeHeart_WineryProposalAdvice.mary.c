...
mary_text_table
{
    ...
    const char gText_RivalEvent_AnnAndCliff_04_OrangeHeart_WineryProposalAdvice_DukeSaysTheyLoveEachOtherAndSuggestsAProposal[] =
        "Sie mag dich... Sicher. \r\n"
        "Du magst sie auch?{Press}\p"
        "Worauf wartest du?\r\n"
        "Du könntest direkt um \r\n"
        "ihre Hand anhalten...{Press}";
