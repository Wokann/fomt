...
mary_text_table
{
    const char gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_BirthdayGiftAcknowledgement[] =
        "Ich habe Geburtstag.{Press}";

    const char gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_FavoriteGiftResponse[] =
        "Das ist sehr wertvoll!\r\n"
        "Ich werde es \r\n"
        "immer in Ehren halten. {Press}";

    const char gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_LikedGiftResponse[] =
        "Das ist für mich?\r\n"
        "Das ist sehr wertvoll?\r\n"
        "Ich werde immer schätzen.{Press}";

    const char gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_NeutralGiftResponse[] =
        "Vielen Dank. {Press}";

    const char gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_DislikedGiftResponse[] =
        "Ich mochte sie noch\r\n"
        "nie... Irgendwas mache\r\n"
        "ich schon damit...{Press}";

    const char gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_HatedGiftResponse[] =
        "Was ist das!?\r\n"
        "Es hat keinen Wert!{Press}";

    const char gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_FavorableAnimalResponse[] =
        "Wie süß...\r\n"
        "Wie soll ich es nennen?{Press}";

    const char gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_UnfavorableAnimalResponse[] =
        "Igitt! \r\n"
        "Bring das bitte nicht \r\n"
        "in meine Nähe!{Press}";

    const char gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_AccessoryGiftResponse[] =
        "Ohh... Wie hübsch!{Press}\p"
        "Du meinst, es ist ein\r\n"
        "Geschenk für mich?! Danke!{Press}";

    const char gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_CosmeticGiftResponse[] =
        "Hmm...\r\n"
        "Sieht sehr wertvoll aus. \r\n"
        "Sicher, dass du es {Press}\r\n"
        "verschenken willst?{Press}";

    const char gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_PerfumeGiftResponse[] =
        "Ganz edles Parfüm.{Press}\p"
        "Es ist ein Geschenk?\r\n"
        "Wie großzügig von dir!{Press}";

    const char gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_CommentsOnBlueFeather[] =
        "Was für eine hübsche \r\n"
        "Feder. Die könnte ich \r\n"
        "sicher teuer verkaufen...{Press}\p"
        "Du meinst, sie ist für\r\n"
        "Heiratsanträge? \r\n"
        "Tut mir Leid...{Press}";

    const char gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_GameCubeLinkIntroductionDialogue[] =
        "Hast du von der Farm{Press}\p"
        "{Place2} drüben im\r\n"
        "Vergissmeinnicht-Tal gehört?{Press}\p"
        "Ich höre, sie machen \r\n"
        "ungeheuren Gewinn!  Ob\r\n"
        "sie wohl etwas Uner- {Press}\r\n"
        "laubtes machen...{Press}";

    const char gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_GameCubeAlbumUnlockUpcomingVisit[] =
        "Ich hoffe, ich komme bald\r\n"
        "ins Vergissmeinnicht-Tal.{Press}";

    const char gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_GameCubeAlbumUnlockValleyOpportunity[] =
        "Das Vergissmeinnicht-Tal \r\n"
        "scheint voller Möglichkeiten\r\n"
        "zu sein.{Press}\r\n"
        "Ich gehe bald.{Press}";

    const char gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_GameCubeAlbumUnlockReturnVisit[] =
        "Ich denke, ich gehe wieder \r\n"
        "ins Vergissmeinnicht-Tal.{Press}";

    const char gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_Inn2FLowFriendshipFirstConversation[] =
        "Was ist los?{Press}";

    const char gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_Inn2FLowFriendshipRepeatConversation[] =
        "Ich habe die beste Auswahl\r\n"
        "seltener Waren!{Press}";

    const char gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_Inn2FMediumFriendshipFirstConversation[] =
        "Ich habe seltenen Dinge\r\n"
        "aus aller Welt gesammelt.{Press}";

    const char gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_Inn2FMediumFriendshipRepeatConversation[] =
        "Ich kann mir nicht helfen, \r\n"
        "ich will seltene Dinge\r\n"
        "sammeln!  Denkst du, {Press}\p"
        "das ist ein schlechter\r\n"
        "Charakterzug?{Press}";

    const char gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_Inn2FHighFriendshipFirstConversation[] =
        "Von all meinen Reisen \r\n"
        "ist das Vergissmeinnicht-\r\n"
        "Tal mein Lieblingsort. {Press}\p"
        "Es ist so friedlich...{Press}";

    const char gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_Inn2FHighFriendshipRepeatConversation[] =
        "Du solltest mit eigenen \r\n"
        "Augen sehen, wie das\r\n"
        "Vergissmeinnicht-Tal ist!{Press}\p"
        "Ich wette, du magst es.{Press}";
};

void EventScript_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock(void)
{
    int var_0, var_1, var_2, var_3;
    SetEntityAnim(ENTITY_VAN, ANIMATION_VAN_IDLE);
    var_3 = GetEntityFacing(ENTITY_VAN);
    SetEntityFacing(ENTITY_VAN, GetOppositeFacing(GetEntityFacing(ENTITY_PLAYER)));
    TalkOpen();
    ...
    {
        if ((var_0 == NPC_INTERACTION_FAVORITE_GIFT || var_0 == NPC_INTERACTION_LIKED_GIFT || var_0 == NPC_INTERACTION_NEUTRAL_GIFT) && IsCharacterBirthdayToday(CHARACTER_VAN))
        {
            SetTalkPortrait(TALK_PORTRAIT_VAN_HAPPY);
            TalkMessage(gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_BirthdayGiftAcknowledgement);
        }
        else
        {
            switch (var_0)
            {
                case NPC_INTERACTION_FAVORITE_GIFT:
                    SetTalkPortrait(TALK_PORTRAIT_VAN_HAPPY);
                    TalkMessage(gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_FavoriteGiftResponse);
                    break;
                case NPC_INTERACTION_LIKED_GIFT:
                    SetTalkPortrait(TALK_PORTRAIT_VAN_NORMAL);
                    TalkMessage(gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_LikedGiftResponse);
                    break;
                case NPC_INTERACTION_NEUTRAL_GIFT:
                    SetTalkPortrait(TALK_PORTRAIT_VAN_NORMAL);
                    TalkMessage(gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_NeutralGiftResponse);
                    break;
                case NPC_INTERACTION_DISLIKED_GIFT:
                    SetTalkPortrait(TALK_PORTRAIT_VAN_AFRAID);
                    TalkMessage(gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_DislikedGiftResponse);
                    break;
                case NPC_INTERACTION_HATED_GIFT:
                    SetTalkPortrait(TALK_PORTRAIT_VAN_ANGRY);
                    TalkMessage(gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_HatedGiftResponse);
                    break;
                case NPC_INTERACTION_FAVORABLE_ANIMAL_RESPONSE:
                    SetTalkPortrait(TALK_PORTRAIT_VAN_HAPPY);
                    TalkMessage(gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_FavorableAnimalResponse);
                    break;
                case NPC_INTERACTION_UNFAVORABLE_ANIMAL_RESPONSE:
                    SetTalkPortrait(TALK_PORTRAIT_VAN_ANGRY);
                    TalkMessage(gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_UnfavorableAnimalResponse);
                    break;
                case NPC_INTERACTION_ACCESSORY:
                    SetTalkPortrait(TALK_PORTRAIT_VAN_HAPPY);
                    TalkMessage(gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_AccessoryGiftResponse);
                    break;
                case NPC_INTERACTION_COSMETIC:
                    SetTalkPortrait(TALK_PORTRAIT_VAN_HAPPY);
                    TalkMessage(gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_CosmeticGiftResponse);
                    break;
                case NPC_INTERACTION_PERFUME:
                    SetTalkPortrait(TALK_PORTRAIT_VAN_HAPPY);
                    TalkMessage(gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_PerfumeGiftResponse);
                    break;
            }
        }
        if (WasNpcGiftedToday(CHARACTER_VAN) == FALSE)
        {
            switch (var_0)
            {
                case NPC_INTERACTION_FAVORITE_GIFT:
        ...
        if (IsCharacterBirthdayToday(CHARACTER_VAN))
        {
            var_2 *= 5;
        }
        ...
        AddNpcFriendship(CHARACTER_VAN, var_2);
        TalkClose();
        ...
        if (IsPlayerHoldingTool())
        {
            switch (GetPlayerHeldToolId())
            {
                case ITEM_TOOL_BLUE_FEATHER:
                    SetTalkPortrait(TALK_PORTRAIT_VAN_HAPPY);
                    TalkMessage(gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_CommentsOnBlueFeather);
                    break;
            }
        }
        else
        {
            if (VarGet(VAR_GAMECUBE_LINK_VAN_DIALOGUE_PENDING) == TRUE)
            {
                SetTalkPortrait(TALK_PORTRAIT_VAN_NORMAL);
                TalkMessage(gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_GameCubeLinkIntroductionDialogue);
                VarSet(VAR_GAMECUBE_LINK_VAN_DIALOGUE_PENDING, FALSE);
            }
            else
            {
                if (VarGet(VAR_GAMECUBE_LINK_VAN_ALBUM_UNLOCK_DIALOGUE_PENDING) == TRUE)
                {
                    ...
                    switch (var_1)
                    {
                        case 0:
                            SetTalkPortrait(TALK_PORTRAIT_VAN_NORMAL);
                            TalkMessage(gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_GameCubeAlbumUnlockUpcomingVisit);
                            VarSet(VAR_GAMECUBE_LINK_VAN_ALBUM_UNLOCK_DIALOGUE_PENDING, FALSE);
                            UnlockNextVanAlbum();
                            SetLocalLinkMilestone(LOCAL_LINK_MILESTONE_VAN_ALBUM_PROGRESS);
                            break;
                        case 1:
                            SetTalkPortrait(TALK_PORTRAIT_VAN_HAPPY);
                            TalkMessage(gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_GameCubeAlbumUnlockValleyOpportunity);
                            VarSet(VAR_GAMECUBE_LINK_VAN_ALBUM_UNLOCK_DIALOGUE_PENDING, FALSE);
                            UnlockNextVanAlbum();
                            SetLocalLinkMilestone(LOCAL_LINK_MILESTONE_VAN_ALBUM_PROGRESS);
                            break;
                        case 2:
                            SetTalkPortrait(TALK_PORTRAIT_VAN_HAPPY);
                            TalkMessage(gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_GameCubeAlbumUnlockReturnVisit);
                            VarSet(VAR_GAMECUBE_LINK_VAN_ALBUM_UNLOCK_DIALOGUE_PENDING, FALSE);
                            UnlockNextVanAlbum();
                            SetLocalLinkMilestone(LOCAL_LINK_MILESTONE_VAN_ALBUM_PROGRESS);
                            break;
                ...
                {
                    switch (GetEntityLocation(ENTITY_VAN))
                    {
                        case MAP_INN_2F:
                            if (GetNpcFriendship(CHARACTER_VAN) <= 100)
                            {
                                if (WasNpcSpokenToJustNow(CHARACTER_VAN) == FALSE)
                                {
                                    SetTalkPortrait(TALK_PORTRAIT_VAN_NORMAL);
                                    TalkMessage(gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_Inn2FLowFriendshipFirstConversation);
                                }
                                else
                                {
                                    SetTalkPortrait(TALK_PORTRAIT_VAN_HAPPY);
                                    TalkMessage(gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_Inn2FLowFriendshipRepeatConversation);
                                }
                            }
                            else
                            {
                                if (GetNpcFriendship(CHARACTER_VAN) > 100 && GetNpcFriendship(CHARACTER_VAN) <= 200)
                                {
                                    if (WasNpcSpokenToJustNow(CHARACTER_VAN) == FALSE)
                                    {
                                        SetTalkPortrait(TALK_PORTRAIT_VAN_NORMAL);
                                        TalkMessage(gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_Inn2FMediumFriendshipFirstConversation);
                                    }
                                    else
                                    {
                                        SetTalkPortrait(TALK_PORTRAIT_VAN_HAPPY);
                                        TalkMessage(gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_Inn2FMediumFriendshipRepeatConversation);
                                    }
                                }
                                else
                                {
                                    ...
                                    {
                                        SetTalkPortrait(TALK_PORTRAIT_VAN_NORMAL);
                                        TalkMessage(gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_Inn2FHighFriendshipFirstConversation);
                                    }
                                    else
                                    {
                                        SetTalkPortrait(TALK_PORTRAIT_VAN_HAPPY);
                                        TalkMessage(gText_NPCEvent_Van_DialogueGiftAndGameCubeAlbumUnlock_Inn2FHighFriendshipRepeatConversation);
                                    }
                                }
                            }
                            break;
    ...
    TalkClose();
    SetEntityFacing(ENTITY_VAN, var_3);
}
