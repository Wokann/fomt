...
mary_text_table
{
    ...
    const char gText_RivalEvent_AnnAndCliff_03_GreenHeart_InnResidencyInvitation_DougSaysCliffSeemsHauntedByHisPastAndHopesHeStays[] =
        ...
        "als würde er sich \r\n"
        "an etwasso dass{Press}\r\n"
        "Unangenehmes erinnern.{Press}\p"
        "Ich schätze, er hat  \r\n"
        "etwas Schlechtes erlebt,\r\n"
        "bevor er herkam.{Press}\p"
        "Ich hoffe, er bleibt, \r\n"
        "so dass wir ihm helfen \r\n"
        "können zu vergessen! {Press}";
