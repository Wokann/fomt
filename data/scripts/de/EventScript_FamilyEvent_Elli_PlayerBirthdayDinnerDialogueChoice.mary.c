...
mary_text_table
{
    ...
    const char gText_FamilyEvent_Elli_PlayerBirthdayDinnerDialogueChoice_WellMaybeIShouldntExpectYou[] =
        ...
        "erwarten, dass du an meinen\r\n"
        "Geburtstag denkst, aber {Press}\r\n"
        "doch wenigstens an DEINEN!{Press}";
    ...
    const char gText_FamilyEvent_Elli_PlayerBirthdayDinnerDialogueChoice_NowYoureAYearOlderAnd[] =
        "Du bist jetzt ein Jahr\r\n"
        "älter und Vater geworden,\r\n"
        "also ist es Zeit, dass du {Press}\p"
        "aufhörst herumzualbern!{Press}";
