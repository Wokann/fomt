...
void EventScript_FamilyEvent_Popuri_SpouseBirthdayDinner(void)
{
    ...
    SetEntityPosition(ENTITY_POPURI, X(327), Y(114), FACING_DOWN);
    ...
    SetEntityEventScript(ENTITY_POPURI, EventScript_FamilyEvent_Popuri_SpouseBirthdayDinnerDialogueChoice);
    if (VarGet(VAR_POPURI_CHILDBIRTH_EVENT_STATE) == EVENT_LIFECYCLE_COMPLETED)
    {
        SetEntityEventScript(ENTITY_CHILD, EventScript_FamilyEvent_Popuri_SpouseBirthdayDinnerBabyGooGoo);
    }
