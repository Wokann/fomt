...
mary_text_table
{
    const char gText_FestivalEvent_FallHorseRace_Invitation_NoHorseAvailable[] =
        "Morgen sind die Herbst-\r\n"
        "Pferderennen auf \r\n"
        "dem Rosenplatz. {Press}\p"
        "Wenn du ein geeignetes\r\n"
        "Pferd hast, solltest du\r\n"
        "mitmachen. {Press}";
