...
mary_text_table
{
    const char gText_FestivalEvent_FallHorseRace_SpectatorDialogue_Thomas_ThisIsWhereYouCanPlace[] =
        ...
        "abschließen und Medaillen\r\n"
        "gegen Preise eintauschen.{Press}\p"
        "Also, komm zu mir, wenn \r\n"
        "du bereit zum Rennen bist.{Press}";

    const char gText_FestivalEvent_FallHorseRace_SpectatorDialogue_Thomas_YouCanBetEvenIfYou[] =
        "Du kannst auch wetten,\r\n"
        "wenn du mitrennst. \r\n"
        "Die meisten Leute wetten{Press}\r\n"
        "auf sich selber. {Press}";
};
