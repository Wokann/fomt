...
mary_text_table
{
    ...
    const char gText_FamilyEvent_Karen_PlayerBirthdayDinnerDialogueChoice_TeasesPlayerForConfusingSpousesBirthdaysAfterChildbirth[] =
        "Ha ha ha! Unglaublich, dass \r\n"
        "du unsere Geburtstage \r\n"
        "verwechselt hast!{Press}\r\n"
        "Du bist wirklich \r\n"
    ...
    const char gText_FamilyEvent_Karen_PlayerBirthdayDinnerDialogueChoice_TeasesPlayerForConfusingPlayerAndChildBirthdays[] =
        "Ha ha ha! Unglaublich, dass \r\n"
        "du deinen Geburtstag mit {Press}\r\n"
        "{Baby}s verwechselt\r\n"
        "hast! Du bist echt witzig!{Press}";
            ...
            else
            {
                ...
                switch (var_0)
                {
                    ...
                    case CHOICE_OPTION_2:
                        ...
                        SetTalkPortrait(TALK_PORTRAIT_KAREN_HAPPY);
                        ShowTalkHeartIndicator(CHARACTER_KAREN);
                        TalkMessage(gText_FamilyEvent_Karen_PlayerBirthdayDinnerDialogueChoice_TeasesPlayerForConfusingSpousesBirthdaysAfterChildbirth);
                        TalkClose();
                        FadeOutScreen(SCREEN_FADE_STYLE_BLACK_MOSAIC, SCREEN_FADE_SPEED_NORMAL);
                        RemoveEventIcon(EVENT_ICON_SLOT_0);
                        RemoveEventIcon(EVENT_ICON_SLOT_1);
