...
mary_text_table
{
    const char gText_FestivalEvent_MusicFestival_Invitation_Carter_WereHavingTheMusicFestivalTomorrow[] =
        "Morgen um 18 Uhr ist \r\n"
        "das Musikfestival in\r\n"
        "der Kirche. {Press}\p"
        "Möchtest du kommen?{Press}";
