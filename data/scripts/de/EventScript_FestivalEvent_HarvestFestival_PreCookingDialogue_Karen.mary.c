...
mary_text_table
{
    const char gText_FestivalEvent_HarvestFestival_PreCookingDialogue_Karen[] =
        "Ich habe Marmelade gebracht.\r\n"
        "Ich hoffe, es gibt dem \r\n"
        "Eintopf guten Geschmack!{Press}";
};

void EventScript_FestivalEvent_HarvestFestival_PreCookingDialogue_Karen(void)
{
    ...
    TalkMessage(gText_FestivalEvent_HarvestFestival_PreCookingDialogue_Karen);
    TalkClose();
