...
mary_text_table
{
    ...
    const char gText_RivalMarriageEvent_RickAndKaren_05_Wedding_CeremonyWithPopuriIntroduction_RickExplainsPopurisMarriageRelievedHisWorry[] =
        "Jetzt, wo Popuri verheiratet\r\n"
        "ist, mache ich mir keine \r\n"
        "Sorgen mehr um sie!{Press}";

    const char gText_RivalMarriageEvent_RickAndKaren_05_Wedding_CeremonyWithPopuriIntroduction_Shared_PopuriTeasesRickAndRickInvitesPlayer[] =
        "Also meinst du, es ist \r\n"
        "Popuri zu verdanken, dass\r\n"
        "du heiratest?{Press}";
...
void EventScript_RivalMarriageEvent_RickAndKaren_05_Wedding_CeremonyWithPopuriIntroduction(void)
{
    ...
    SetTalkNameplateCharacter(CHARACTER_POPURI);
    TalkMessage(gText_RivalMarriageEvent_RickAndKaren_05_Wedding_CeremonyWithPopuriIntroduction_Shared_PopuriTeasesRickAndRickInvitesPlayer);
    TalkClose();
    WaitFrames(30);
