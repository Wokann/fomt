...
mary_text_table
{
    ...
    const char gText_NPCEvent_GrayAndKai_KaiCooksForGray_GrayExplainsKaiInvitedHim[] =
        ...
        "dass ich bei Kai bin?{Press}\p"
        "Mag sein, aber er hat\r\n"
        "mich eingeladen.{Press}";

    const char gText_NPCEvent_GrayAndKai_KaiCooksForGray_KaiValuesGraysCityFoodExperience[] =
        "Gray ist der Einzige, der \r\n"
        "weiß, wie das Essen in\r\n"
        "der Stadt schmeckt. {Press}\r\n"
        "Also schätze ich\r\n"
        "seine Meinung. {Press}";
