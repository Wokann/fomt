...
mary_text_table
{
    ...
    const char gText_FamilyEvent_Ann_PlayerBirthdayDinnerDialogueChoice_SorryTryAgainItsYourOwn[] =
        "Sorry, versuch's noch mal.\r\n"
        "Dein eigener Geburtstag!\r\n"
        "Willst du mich vereimern?{Press}";
    ...
    const char gText_FamilyEvent_Ann_PlayerBirthdayDinnerDialogueChoice_ThatsRightYoureGettingOlderNow[] =
        "Richtig! Du wirst älter,\r\n"
        "also hast du auch mehr\r\n"
        "Verantwortung!{Press}";
    ...
    const char gText_FamilyEvent_Ann_PlayerBirthdayDinnerDialogueChoice_MyBirthdayGetAGripIts[] =
        "Mein Geburtstag!?...\r\n"
        "Reiß dich zusammen! Es ist\r\n"
        "DEIN Geburtstag!{Press}";

    const char gText_FamilyEvent_Ann_PlayerBirthdayDinnerDialogueChoice_BabySBirthday[] =
        "{Baby}s Geburtstag";

    const char gText_FamilyEvent_Ann_PlayerBirthdayDinnerDialogueChoice_PlayerGetsOlderAfterChildbirth[] =
        "Richtig! Du wirst älter, \r\n"
        "also hast du auch mehr\r\n"
        "Verantwortung!{Press}";
    ...
    const char gText_FamilyEvent_Ann_PlayerBirthdayDinnerDialogueChoice_StopFoolingMeIKnowYou[] =
        "Hör auf, mich auf\r\n"
        "den Arm zu nehmen!\r\n"
        "Ich weiß, dass du weißt,{Press}\p"
        "dass es dein Geburtstag ist!{Press}";
            ...
            else
            {
                ...
                switch (var_0)
                {
                    case CHOICE_OPTION_1:
                        ...
                        SetTalkPortrait(TALK_PORTRAIT_ANN_HAPPY);
                        ShowTalkHeartIndicator(CHARACTER_ANN);
                        TalkMessage(gText_FamilyEvent_Ann_PlayerBirthdayDinnerDialogueChoice_PlayerGetsOlderAfterChildbirth);
                        TalkClose();
                        SetEntityAnim(ENTITY_PLAYER, ANIMATION_PLAYER_LOWER_HEAD);
                        WaitFrames(60);
                        if (IsPlayerHoldingNothing())
