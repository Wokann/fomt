...
mary_text_table
{
    const char gText_FamilyEvent_Mary_SpouseCollapseRecovery_MaryAttributesCollapseToFarmLifeInexperience[] =
        "Ich bin wohl einfach\r\n"
        "noch nicht an das Farm-\r\n"
        "leben gewöhnt! Ich muss mich{Press}\p"
        "mehr damit beschäftigen...{Press}";

    const char gText_FamilyEvent_Mary_SpouseCollapseRecovery_MaryPlansToRecoverWithMedicineAndRest[] =
        "Ich habe Medizin genommen,\r\n"
        "denke, ich erhole mich,\r\n"
        "wenn ich einfach schlafe.{Press}";
};
