...
mary_text_table
{
    ...
    const char gText_ShopEvent_Blacksmith_OrderCounter_Shared_MystrileAndMythicHammer[] =
        "Mythrilhammer";
    ...
    const char gText_ShopEvent_Blacksmith_OrderCounter_CompletedToolOrAccessoryCollectedByHand[] =
        "Dein {Var1}\r\n"
        "ist fertig zum\r\n"
        "Mitnehmen.{Press}\r\n"
        "{Press}";
    ...
    const char gText_ShopEvent_Blacksmith_OrderCounter_CompletedMakerReady[] =
        "{Var1}\r\n"
        "ist fertig wie bestellt.{Press}\r\n"
        "{Press}";

    const char gText_ShopEvent_Blacksmith_OrderCounter_GrayWillDeliverCompletedMaker[] =
        "Gray liefert die Bestellung.\r\n"
        "{Press}";

    const char gText_ShopEvent_Blacksmith_OrderCounter_CompletedToolOrAccessoryCollectedIntoRucksack[] =
        "{Var1}\r\n"
        "ist fertig zum\r\n"
        "Mitnehmen.{Press}\r\n"
        "{Press}";
    ...
    const char gText_ShopEvent_Blacksmith_OrderCounter_CompletedToolSentToStorageBecauseRucksackFull[] =
        "{Var1}\r\n"
        "ist fertig.{Press}\p"
        "Dein Rucksack scheint\r\n"
        "voll zu sein.{Press}\p"
        "Gray wird\r\n"
        "dir alles liefern.{Press}";
            ...
            if (IsBlacksmithOrderReady() == TRUE)
            {
                ...
                switch (var_2)
                {
                    ...
                    case BLACKSMITH_ORDER_HAMMER_MYSTRILE:
                        SetTextVariableString(TEXT_VARIABLE_1, gText_ShopEvent_Blacksmith_OrderCounter_Shared_MystrileAndMythicHammer);
                ...
                switch (var_3)
                {
                    case BLACKSMITH_COLLECTION_HELD:
                        switch (var_0)
                        {
                            case BLACKSMITH_PRODUCT_CATEGORY_TOOL:
                                TalkMessage(gText_ShopEvent_Blacksmith_OrderCounter_CompletedToolOrAccessoryCollectedByHand);
                                TalkClose();
                    ...
                    case BLACKSMITH_COLLECTION_RUCKSACK:
                        ...
                        {
                            case BLACKSMITH_PRODUCT_CATEGORY_TOOL:
                                TalkMessage(gText_ShopEvent_Blacksmith_OrderCounter_CompletedToolOrAccessoryCollectedIntoRucksack);
                                TalkClose();
                                if (IsPlayerHoldingNothing() == TRUE)
                                {
                                    PlaySong(AUDIO_START, AUDIO_SFX_ATTENTION_CHIME);
