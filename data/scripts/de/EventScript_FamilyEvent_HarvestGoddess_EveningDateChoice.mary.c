...
mary_text_table
{
    ...
    const char gText_FamilyEvent_HarvestGoddess_EveningDateChoice_CorrectHarvestGoddessBirthdayResponse[] =
        "Ja, mein Geburtstag!{Press}\p"
        "Du hast nichts gesagt, da\r\n"
...
void EventScript_FamilyEvent_HarvestGoddess_EveningDateChoice(void)
{
    ...
    switch (var_0)
    {
        case CHOICE_OPTION_1:
            ...
            {
                var_0 = TalkChoice3(gText_FamilyEvent_HarvestGoddess_EveningDateChoice_ChoiceHarvestGoddessBirthday, gText_FamilyEvent_HarvestGoddess_EveningDateChoice_ChoiceWeddingAnniversary, gText_FamilyEvent_HarvestGoddess_EveningDateChoice_ChoiceChildBirthday);
                switch (var_0)
                {
                    case CHOICE_OPTION_1:
                        AddCharacterLove(CHARACTER_HARVEST_GODDESS, mary_negated_int(-2000));
                    ...
                    case CHOICE_OPTION_2:
                        ...
                        SetTalkNameplateCharacter(CHARACTER_HARVEST_GODDESS);
                        SetTalkPortrait(TALK_PORTRAIT_HARVEST_GODDESS_HAPPY);
                        TalkMessage(gText_FamilyEvent_HarvestGoddess_EveningDateChoice_CorrectHarvestGoddessBirthdayResponseAfterChildbirth);
                        TalkClose();
                        SetEntityAnim(ENTITY_PLAYER, ANIMATION_PLAYER_LOWER_HEAD);
                        WaitFrames(60);
                        if (IsPlayerHoldingNothing())
