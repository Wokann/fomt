...
void EventScript_FamilyEvent_Popuri_PlayerBirthdayDinner(void)
{
    ...
    SetEntityEventScript(ENTITY_POPURI, EventScript_FamilyEvent_Popuri_PlayerBirthdayDinnerDialogueChoice);
    if (VarGet(VAR_POPURI_CHILDBIRTH_EVENT_STATE) == EVENT_LIFECYCLE_COMPLETED)
    {
        SetEntityEventScript(ENTITY_CHILD, EventScript_FamilyEvent_Popuri_PlayerBirthdayDinnerBabyGooGoo);
    }
