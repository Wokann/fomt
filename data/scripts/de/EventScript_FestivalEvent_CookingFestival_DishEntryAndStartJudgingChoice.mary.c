...
mary_text_table
{
    ...
    const char gText_FestivalEvent_CookingFestival_DishEntryAndStartJudgingChoice_PlaceYourDishAlongWithEverybody[] =
        "Stell dein Gericht zu \r\n"
        "all den anderen. {Press}\p"
        "Der Gourmet wird sie\r\n"
        "probieren und den \r\n"
        "Gewinner bekannt geben.{Press}\p"
        "Können wir jetzt beginnen?{Press}";
    ...
    const char gText_FestivalEvent_CookingFestival_DishEntryAndStartJudgingChoice_WeCantBeginTheJudgingIf[] =
        ...
        "der Bewertung beginnen,\r\n"
        "so lange du {Press}\r\n"
        "nicht fertig bist! {Press}";
};
