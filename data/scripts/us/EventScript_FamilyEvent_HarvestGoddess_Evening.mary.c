...
void EventScript_FamilyEvent_HarvestGoddess_Evening(void)
{
    ...
    SetEntityEventScript(ENTITY_HARVEST_GODDESS, EventScript_FamilyEvent_HarvestGoddess_EveningDateChoice);
    if (VarGet(VAR_HARVEST_GODDESS_CHILDBIRTH_EVENT_STATE) == EVENT_LIFECYCLE_COMPLETED)
    {
        SetEntityEventScript(ENTITY_CHILD, EventScript_FamilyEvent_HarvestGoddess_EveningChildDialogue);
    }
