...
mary_text_table
{
    const char gText_FestivalEvent_FireworksFestival_Dialogue_Rick[] =
        "It wouldn't be Summer \r\n"
        "without the Firework\r\n"
        "Festival!{Press}";
};

void EventScript_FestivalEvent_FireworksFestival_Dialogue_Rick(void)
{
    ...
    TalkMessage(gText_FestivalEvent_FireworksFestival_Dialogue_Rick);
    TalkClose();
