...
mary_text_table
{
    const char gText_FamilyEvent_Karen_BabyBirthdayBabbles[] =
        "Goo-goo.{Press}";
};

void EventScript_FamilyEvent_Karen_BabyBirthdayBabbles(void)
{
    ...
    TalkMessage(gText_FamilyEvent_Karen_BabyBirthdayBabbles);
    TalkClose();
