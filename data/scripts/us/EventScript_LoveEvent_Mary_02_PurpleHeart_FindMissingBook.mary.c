...
mary_text_table
{
    ...
    const char gText_LoveEvent_Mary_02_PurpleHeart_MaryWelcomesPlayer[] =
        "Welcome. Did you come \r\n"
        "to read a book?{Press}\r\n"
        "Hmm? \r\n"
        "What am I looking for? {Press}";

    const char gText_LoveEvent_Mary_02_PurpleHeart_MaryExplainsBookIsMissing[] =
        "Well, there's a book I'm\r\n"
        "using as a reference for \r\n"
        "the novel I'm writing.{Press}\p"
        "I think it's on the first\r\n"
        "floor, but I can't find it!{Press}";

    const char gText_LoveEvent_Mary_02_PurpleHeart_MaryAsksPlayerToHelpSearch[] =
        "Terribly sorry to ask, but \r\n"
