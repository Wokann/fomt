...
void EventScript_FamilyEvent_Ann_BabyBirthday(void)
{
    ...
    SetEntityEventScript(ENTITY_ANN, EventScript_FamilyEvent_Ann_BabyBirthdayDateDialogueChoice);
    SetEntityEventScript(ENTITY_CHILD, EventScript_FamilyEvent_Ann_BabyBirthdayGooGoo);
