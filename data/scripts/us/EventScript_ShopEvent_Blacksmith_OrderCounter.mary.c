...
mary_text_table
{
    ...
    const char gText_ShopEvent_Blacksmith_OrderCounter_CompletedAccessoryScheduledForDeliveryBecauseRucksackFull[] =
        "Your Ruchsack seems to\r\n"
        "be full.{Press}\p"
        "I'll have Grey deliver your\r\n"
        "{Var1} to you later.\r\n"
        "Look forward to it.{Press}";

    const char gText_ShopEvent_Blacksmith_OrderCounter_CompletedToolHeldUntilRucksackHasSpace[] =
        "{Var1} is ready,\r\n"
        "but your Rucksack is full.{Press}\p"
        "Go home, drop off\r\n"
        "some items and come back\r\n"
        "to get your new tool.{Press}";

    const char gText_ShopEvent_Blacksmith_OrderCounter_CompletedAccessoryHeldUntilHandsHaveSpace[] =
        "The {Var1}\r\n"
        "you asked me to make\r\n"
        "is done now...{Press}\p"
        "But, you seem to have your\r\n"
        "hands full now, so I'll \r\n"
        "hold onto the necklace {Press}\r\n"
        "for now, OK?{Press}";

    const char gText_ShopEvent_Blacksmith_OrderCounter_WhatWouldYouLikeTodayI[] =
        "What would you like \r\n"
        "today? I always like to \r\n"
        "talk, as long as I'm {Press}\r\n"
        "not working.{Press}";

    const char gText_ShopEvent_Blacksmith_OrderCounter_Counters[] =
        "Counters{Press}";
};
...
void EventScript_ShopEvent_Blacksmith_OrderCounter(void)
{
    ...
    if (GetEntityFacing(ENTITY_PLAYER) == FACING_UP)
    {
        ...
        {
            TalkOpen();
            TalkMessage(gText_ShopEvent_Blacksmith_OrderCounter_Counters);
        }
    }
    else
    {
