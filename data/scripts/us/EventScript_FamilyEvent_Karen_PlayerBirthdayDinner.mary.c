...
void EventScript_FamilyEvent_Karen_PlayerBirthdayDinner(void)
{
    ...
    SetEntityEventScript(ENTITY_KAREN, EventScript_FamilyEvent_Karen_PlayerBirthdayDinnerDialogueChoice);
    if (VarGet(VAR_KAREN_CHILDBIRTH_EVENT_STATE) == EVENT_LIFECYCLE_COMPLETED)
    {
        SetEntityEventScript(ENTITY_CHILD, EventScript_FamilyEvent_Karen_PlayerBirthdayDinnerBabyBabbles);
    }
