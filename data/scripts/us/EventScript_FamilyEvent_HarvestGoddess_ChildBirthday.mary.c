...
void EventScript_FamilyEvent_HarvestGoddess_ChildBirthday(void)
{
    ...
    SetEntityEventScript(ENTITY_HARVEST_GODDESS, EventScript_FamilyEvent_HarvestGoddess_ChildBirthdayDateChoice);
    SetEntityEventScript(ENTITY_CHILD, EventScript_FamilyEvent_HarvestGoddess_ChildBirthdayChildDialogue);
