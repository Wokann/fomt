...
mary_text_table
{
    const char gText_FestivalEvent_CookingFestival_PreJudgingDialogue_Ann[] =
        "I'm feeling confident today!{Press}";
};

void EventScript_FestivalEvent_CookingFestival_PreJudgingDialogue_Ann(void)
{
    ...
    TalkMessage(gText_FestivalEvent_CookingFestival_PreJudgingDialogue_Ann);
    TalkClose();
