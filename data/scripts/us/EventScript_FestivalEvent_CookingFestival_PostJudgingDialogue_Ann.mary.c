...
mary_text_table
{
    const char gText_FestivalEvent_CookingFestival_PostJudgingDialogue_Ann[] =
        "I can't make anything \r\n"
        "really fancy, you know. {Press}";
};

void EventScript_FestivalEvent_CookingFestival_PostJudgingDialogue_Ann(void)
{
    ...
    TalkMessage(gText_FestivalEvent_CookingFestival_PostJudgingDialogue_Ann);
    TalkClose();
