...
mary_text_table
{
    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_Introduction[] =
        "You're not from around\r\n"
        "here, are you? {Press}\p"
        "My name? It's Stu.\r\n"
        "Hey, you have cows on\r\n"
        "your farm, right? {Press}\p"
        "Can I come pet one?{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_BirthdayGiftResponsePart1[] =
        "Well, I really wanted \r\n"
        "Mechabot Ultror, but \r\n"
        "thanks anyway!{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_BirthdayGiftResponsePart2[] =
        "Just remember next\r\n"
        "year, OK?{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_FavoriteGiftResponse[] =
        "Wow!\r\n"
        "Thanks!{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_LikedOrNeutralGiftResponse[] =
        "Thanks!{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_DislikedGiftResponse[] =
        "I think maybe I'll\r\n"
        "give this to Grandma...!{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_HatedGiftResponse[] =
        "Can't you give this\r\n"
        "to somebody else?{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_FavorableAnimalResponse[] =
        "Gee, thanks!{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_UnfavorableAnimalResponse[] =
        "Gosh! You mean this\r\n"
        "is really for me?{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_AccessoryGiftResponse[] =
        "Thanks! When I get older,\r\n"
        "I'll give it to a girl \r\n"
        "I like. {Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_CosmeticGiftResponse[] =
        "Thanks, but I won't\r\n"
        "use it, so I'll give it\r\n"
        "to my sister Elli.{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_PerfumeGiftResponse[] =
        "Ewww....\r\n"
        "What's this...?{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_CommentsOnBlueFeather[] =
        "Wow...It's pretty!\r\n"
        "We had something like it\r\n"
        "in our house...{Press}\p"
        "Elli said it was mom's.{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseMorningFriendship0To100FirstConversation[] =
        "Hi there!{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseMorningFriendship0To100RepeatConversation[] =
        "You look like you're \r\n"
        "as bored as me!{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseMorningFriendship101To200FirstConversation[] =
        "Hey...{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseMorningFriendship101To200RepeatConversation[] =
        "Have you ever ridden a cow?\r\n"
        "I want to do Rodeo. {Press}\p"
        "...You don’t know Rodeo? \r\n"
        "Milk Cows are different from\r\n"
        "Rodeo Cows, I heard...{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseMorningFriendshipAbove200FirstConversation[] =
        "Won't you play with me?{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseMorningFriendshipAbove200RepeatConversation[] =
        "Elli's always at work, \r\n"
        "and Grandma can't walk \r\n"
        "good, so I don't have {Press}\r\n"
        "anyone to play with!{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseAfternoonSunnyNonMondayOrWednesdayFirstConversation[] =
        "Tomorrow is Church day!{Press}\p"
        "Do you go, too? Ever \r\n"
        "been to confessional?{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseAfternoonSunnyNonMondayOrWednesdayRepeatConversation[] =
        "Carter says that we can be\r\n"
        "forgiven for everything if\r\n"
        "we truly feel sorry.{Press}\p"
        "I do sorta feel bad about \r\n"
        "putting bugs in Elli's bed.{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseAfternoonNonSunnyNonMondayOrWednesdayFirstConversation[] =
        "I'm so bored...!\r\n"
        "I wonder if May's at home?{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseAfternoonNonSunnyNonMondayOrWednesdayRepeatConversation[] =
        "I wish there was someone who\r\n"
        "would take me to the Church\r\n"
        "when it was raining...{Press}\p"
        "Maybe Carter would come...{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseAfternoonMondayOrWednesdayFirstConversation[] =
        "Today isn't a Church day.{Press}\p"
        "My sis Elli is free on \r\n"
        "Wednesdays, and on Mondays\r\n"
        "May goes out with her{Press}\r\n"
        "grandfather.{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseAfternoonMondayOrWednesdayRepeatConversation[] =
        "I don't like playing mommy\r\n"
        "all day, you know!{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseOutsideMorningOrAfternoonFirstConversation[] =
        "Hi!{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseOutsideMorningOrAfternoonRepeatConversation[] =
        "It's my bed time...{Press}\p"
        "If I stay up longer, the \r\n"
        "monsters will come get me!{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_NorthSideTownFirstConversation[] =
        "Hello!{Press}";

    const char gText_NPCEvent_Stu_DialogueAndGiftResponses_NorthSideTownRepeatConversation[] =
        "Carter makes really good \r\n"
        "food, you know.{Press}";
};

void EventScript_NPCEvent_Stu_DialogueAndGiftResponses(void)
{
    int var_0, var_1, var_2;
    SetEntityAnim(ENTITY_STU, ANIMATION_STU_IDLE);
    var_2 = GetEntityFacing(ENTITY_STU);
    ...
    {
        switch (GetEntityLocation(ENTITY_STU))
        {
            case MAP_FARM:
                CallScript(EventScript_FestivalEvent_PumpkinFestival_TreatVisit_Stu);
                break;
        }
    }
    TalkOpen();
    ...
    if (HasMetNpc(CHARACTER_STU) == FALSE)
    {
        ...
        TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_Introduction);
    ...
    else
    {
        ...
        {
            if ((var_0 == NPC_INTERACTION_FAVORITE_GIFT || var_0 == NPC_INTERACTION_LIKED_GIFT || var_0 == NPC_INTERACTION_NEUTRAL_GIFT) && IsCharacterBirthdayToday(CHARACTER_STU))
            {
                SetTalkPortrait(TALK_PORTRAIT_STU_AFRAID);
                TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_BirthdayGiftResponsePart1);
                SetTalkPortrait(TALK_PORTRAIT_STU_HAPPY);
                TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_BirthdayGiftResponsePart2);
            }
            else
            {
                switch (var_0)
                {
                    case NPC_INTERACTION_FAVORITE_GIFT:
                        SetTalkPortrait(TALK_PORTRAIT_STU_HAPPY);
                        TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_FavoriteGiftResponse);
                        break;
                    case NPC_INTERACTION_LIKED_GIFT:
                        SetTalkPortrait(TALK_PORTRAIT_STU_HAPPY);
                        TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_LikedOrNeutralGiftResponse);
                        break;
                    ...
                    case NPC_INTERACTION_DISLIKED_GIFT:
                        SetTalkPortrait(TALK_PORTRAIT_STU_AFRAID);
                        TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_DislikedGiftResponse);
                        break;
                    case NPC_INTERACTION_HATED_GIFT:
                        SetTalkPortrait(TALK_PORTRAIT_STU_ANGRY);
                        TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_HatedGiftResponse);
                        break;
                    case NPC_INTERACTION_FAVORABLE_ANIMAL_RESPONSE:
                        SetTalkPortrait(TALK_PORTRAIT_STU_HAPPY);
                        TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_FavorableAnimalResponse);
                        break;
                    case NPC_INTERACTION_UNFAVORABLE_ANIMAL_RESPONSE:
                        SetTalkPortrait(TALK_PORTRAIT_STU_NORMAL);
                        TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_UnfavorableAnimalResponse);
                        break;
                    case NPC_INTERACTION_ACCESSORY:
                        SetTalkPortrait(TALK_PORTRAIT_STU_NORMAL);
                        TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_AccessoryGiftResponse);
                        break;
                    case NPC_INTERACTION_COSMETIC:
                        SetTalkPortrait(TALK_PORTRAIT_STU_NORMAL);
                        TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_CosmeticGiftResponse);
                        break;
                    case NPC_INTERACTION_PERFUME:
                        SetTalkPortrait(TALK_PORTRAIT_STU_NORMAL);
                        TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_PerfumeGiftResponse);
                        break;
                }
            }
            if (WasNpcGiftedToday(CHARACTER_STU) == FALSE)
            {
                switch (var_0)
                {
                    case NPC_INTERACTION_FAVORITE_GIFT:
            ...
            if (IsCharacterBirthdayToday(CHARACTER_STU))
            {
                var_1 *= 5;
            }
            ...
            AddNpcFriendship(CHARACTER_STU, var_1);
            TalkClose();
            ...
            if (IsPlayerHoldingTool())
            {
                switch (GetPlayerHeldToolId())
                {
                    case ITEM_TOOL_BLUE_FEATHER:
                        SetTalkPortrait(TALK_PORTRAIT_STU_HAPPY);
                        TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_CommentsOnBlueFeather);
                        break;
                }
            }
            else
            {
                switch (GetEntityLocation(ENTITY_STU))
                {
                    case MAP_ELLEN_HOUSE:
                        ...
                        {
                            if (GetNpcFriendship(CHARACTER_STU) <= 100)
                            {
                                if (WasNpcSpokenToJustNow(CHARACTER_STU) == FALSE)
                                {
                                    SetTalkPortrait(TALK_PORTRAIT_STU_NORMAL);
                                    TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseMorningFriendship0To100FirstConversation);
                                }
                                else
                                {
                                    SetTalkPortrait(TALK_PORTRAIT_STU_HAPPY);
                                    TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseMorningFriendship0To100RepeatConversation);
                                }
                            }
                            else
                            {
                                if (GetNpcFriendship(CHARACTER_STU) > 100 && GetNpcFriendship(CHARACTER_STU) <= 200)
                                {
                                    if (WasNpcSpokenToJustNow(CHARACTER_STU) == FALSE)
                                    {
                                        SetTalkPortrait(TALK_PORTRAIT_STU_HAPPY);
                                        TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseMorningFriendship101To200FirstConversation);
                                    }
                                    else
                                    {
                                        SetTalkPortrait(TALK_PORTRAIT_STU_NORMAL);
                                        TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseMorningFriendship101To200RepeatConversation);
                                    }
                                }
                                else
                                {
                                    ...
                                    {
                                        SetTalkPortrait(TALK_PORTRAIT_STU_NORMAL);
                                        TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseMorningFriendshipAbove200FirstConversation);
                                    }
                                    else
                                    {
                                        SetTalkPortrait(TALK_PORTRAIT_STU_AFRAID);
                                        TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseMorningFriendshipAbove200RepeatConversation);
                                    }
                                }
                            }
                        }
                        ...
                        {
                            if (VarGet(VAR_HOUR) >= 12 && VarGet(VAR_HOUR) < 16)
                            {
                                if (VarGet(VAR_DAY_OF_WEEK) != DAY_OF_WEEK_MONDAY && VarGet(VAR_DAY_OF_WEEK) != DAY_OF_WEEK_WEDNESDAY)
                                {
                                    if (VarGet(VAR_WEATHER_TODAY) == WEATHER_SUNNY)
                                    {
                                        ...
                                        {
                                            SetTalkPortrait(TALK_PORTRAIT_STU_NORMAL);
                                            TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseAfternoonSunnyNonMondayOrWednesdayFirstConversation);
                                        }
                                        else
                                        {
                                            SetTalkPortrait(TALK_PORTRAIT_STU_HAPPY);
                                            TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseAfternoonSunnyNonMondayOrWednesdayRepeatConversation);
                                        }
                                    }
                                    else
                                    {
                                        ...
                                        {
                                            SetTalkPortrait(TALK_PORTRAIT_STU_AFRAID);
                                            TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseAfternoonNonSunnyNonMondayOrWednesdayFirstConversation);
                                        }
                                        else
                                        {
                                            SetTalkPortrait(TALK_PORTRAIT_STU_AFRAID);
                                            TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseAfternoonNonSunnyNonMondayOrWednesdayRepeatConversation);
                                        }
                                    }
                                }
                                else
                                {
                                    ...
                                    {
                                        SetTalkPortrait(TALK_PORTRAIT_STU_NORMAL);
                                        TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseAfternoonMondayOrWednesdayFirstConversation);
                                    }
                                    else
                                    {
                                        SetTalkPortrait(TALK_PORTRAIT_STU_NORMAL);
                                        TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseAfternoonMondayOrWednesdayRepeatConversation);
                                    }
                                }
                            }
                            else
                            {
                                ...
                                {
                                    SetTalkPortrait(TALK_PORTRAIT_STU_NORMAL);
                                    TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseOutsideMorningOrAfternoonFirstConversation);
                                }
                                else
                                {
                                    SetTalkPortrait(TALK_PORTRAIT_STU_AFRAID);
                                    TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_EllenHouseOutsideMorningOrAfternoonRepeatConversation);
                                }
                            }
                        }
                        break;
                    case MAP_NORTH_SIDE_TOWN:
                        ...
                        {
                            SetTalkPortrait(TALK_PORTRAIT_STU_NORMAL);
                            TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_NorthSideTownFirstConversation);
                        }
                        else
                        {
                            SetTalkPortrait(TALK_PORTRAIT_STU_HAPPY);
                            TalkMessage(gText_NPCEvent_Stu_DialogueAndGiftResponses_NorthSideTownRepeatConversation);
                        }
                        break;
                }
                MarkNpcSpokenTo(CHARACTER_STU);
    ...
    TalkClose();
    SetEntityFacing(ENTITY_STU, var_2);
}
