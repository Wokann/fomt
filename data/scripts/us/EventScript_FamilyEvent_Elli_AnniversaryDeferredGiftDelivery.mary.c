...
mary_text_table
{
    const char gText_FamilyEvent_Elli_AnniversaryDeferredGiftDelivery_GiftDelivery[] =
        "Here you are, {NickName}.{Press}";

    const char gText_FamilyEvent_Elli_AnniversaryDeferredGiftDelivery_HandsOccupiedReminder[] =
        "I'm going to give you a \r\n"
        "present, so empty your \r\n"
        "hands, OK?{Press}";
};

void EventScript_FamilyEvent_Elli_AnniversaryDeferredGiftDelivery(void)
{
    ...
    if (IsPlayerHoldingNothing())
    {
        ...
        TalkMessage(gText_FamilyEvent_Elli_AnniversaryDeferredGiftDelivery_GiftDelivery);
        TalkClose();
    ...
    else
    {
        ...
        TalkMessage(gText_FamilyEvent_Elli_AnniversaryDeferredGiftDelivery_HandsOccupiedReminder);
        TalkClose();
    }
