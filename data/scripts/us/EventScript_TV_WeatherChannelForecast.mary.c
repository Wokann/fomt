...
mary_text_table
{
    ...
    const char gText_TV_WeatherChannelForecast_SummerTyphoon[] =
        "This is tomorrow's forecast!\r\n"
        "A typhoon will be passing\r\n"
        ...
        case SEASON_SUMMER:
            ...
            else
            {
                switch (VarGet(VAR_WEATHER_TOMORROW))
                {
                    ...
                    case WEATHER_TYPHOON:
                        SetTelevisionProgram(TELEVISION_PROGRAM_WEATHER_TYPHOON);
                        var_0 = ShowTelevisionMessage(gText_TV_WeatherChannelForecast_SummerTyphoon);
                        break;
                    case WEATHER_SNOW:
                        SetTelevisionProgram(TELEVISION_PROGRAM_NO_SIGNAL);
                        var_0 = ShowTelevisionMessage(gText_TV_WeatherChannelForecast_NoSignalSnow);
