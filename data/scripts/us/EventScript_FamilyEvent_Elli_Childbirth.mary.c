...
mary_text_table
{
    ...
    const char gText_FamilyEvent_Elli_Childbirth_EllenWishesEllisMotherCouldSeeBirth[] =
        "I wish Elli's mother could\r\n"
        "have been here now...{Press}";
