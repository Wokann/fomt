...
mary_text_table
{
    const char gText_FestivalEvent_StockingGift_ThomasDelivery_NoStockingInstalled[] =
        "Thump!!...Phew, it's a lot\r\n"
        "harder to sneak into houses\r\n"
        "than I thought!{Press}\p"
        "Wait, there's no stocking \r\n"
        "here!...{Press}\p"
        "That means I can't leave my\r\n"
        "present. Too bad!{Press}\p"
        "I guess I'll have to bring\r\n"
        "it back with me...{Press}";

    const char gText_FestivalEvent_StockingGift_ThomasDelivery_GiftPlacedInEmptyStocking[] =
        "Thump!!...Phew, it's a lot\r\n"
        "harder to sneak into houses\r\n"
        "than I thought!{Press}\p"
        "Good, he remembered to put\r\n"
        "a stocking up. {Press}\p"
        "But it's so dark I can't\r\n"
        "see which present is his!{Press}\p"
        "Oh well, I'll just assume\r\n"
        "it's this one!{Press}";
    ...
    const char gText_FestivalEvent_StockingGift_ThomasDelivery_ExistingGiftBlocksDelivery[] =
        ...
        "care for the trouble I go {Press}\r\n"
        "through to do this!{Press}\p"
        "How depressing...I'll \r\n"
        "just go home, I guess...{Press}";
};
