...
mary_text_table
{
    ...
    const char gText_ShopEvent_Clinic_ExaminationChoice_Recommendation_TurbojoltOrRest[] =
        "One bottle of Turbojolt\r\n"
        "would be best, but a good\r\n"
        "night's sleep and lots of{Press}\r\n"
        "food will do you fine!{Press}";

    const char gText_ShopEvent_Clinic_ExaminationChoice_Recommendation_TurbojoltOrFullDayRest[] =
        "You should take one bottle\r\n"
        "of Turbojolt, but if you\r\n"
        "just can't afford it, go{Press}\p"
        "home and take the rest\r\n"
        "of the day off.{Press}";

    const char gText_ShopEvent_Clinic_ExaminationChoice_Recommendation_BodigizerOrRest[] =
        "One bottle of Bodigizer\r\n"
        "would be best, but a good{Press}\r\n"
        "night's sleep and lots of\r\n"
        "food will do you fine!{Press}";

    const char gText_ShopEvent_Clinic_ExaminationChoice_Recommendation_BodigizerAndTurbojoltOrFullDayRest[] =
        "You should take one bottle\r\n"
        "of Bodigizer and one of\r\n"
        "Turbojolt, but if you{Press}\p"
        "just can't afford it, go\r\n"
        "home and take the rest\r\n"
        "of the day off.{Press}";

    const char gText_ShopEvent_Clinic_ExaminationChoice_TooBadButYouDontHave[] =
        "Too bad, but you\r\n"
        "don't have enough money.{Press}";

    const char gText_ShopEvent_Clinic_ExaminationChoice_YourePositiveNowWellIfYou[] =
        "You're positive, now?\r\n"
        "Well, if you think you're\r\n"
        "OK, then I guess there's no {Press}\r\n"
        "reason to worry.{Press}\p"
