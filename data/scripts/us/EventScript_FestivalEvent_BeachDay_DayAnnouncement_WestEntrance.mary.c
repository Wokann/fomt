...
mary_text_table
{
    const char gText_FestivalEvent_BeachDay_DayAnnouncement_WestEntrance_ThomasAnnouncesStartTimeAndInvitesPlayer[] =
...
void EventScript_FestivalEvent_BeachDay_DayAnnouncement_WestEntrance(void)
{
    ...
    SetEntityPosition(ENTITY_THOMAS, X(48), Y(280), FACING_LEFT);
    ...
    if (VarGet(VAR_BEACH_DAY_FESTIVAL_ACTIVE) == FESTIVAL_PHASE_INACTIVE && var_0 == SEASON_SUMMER && var_1 == DAY_OF_MONTH_01)
    {
        ...
        TalkMessage(gText_FestivalEvent_BeachDay_DayAnnouncement_WestEntrance_ThomasAnnouncesStartTimeAndInvitesPlayer);
        TalkClose();
