...
mary_text_table
{
    const char gText_FestivalEvent_CookingFestival_PostJudgingDialogue_Karen[] =
        "I think I've got a \r\n"
        "good chance...{Press}";
};

void EventScript_FestivalEvent_CookingFestival_PostJudgingDialogue_Karen(void)
{
    ...
    TalkMessage(gText_FestivalEvent_CookingFestival_PostJudgingDialogue_Karen);
    TalkClose();
