...
mary_text_table
{
    ...
    const char gText_NPCEvent_Popuri_BringsCustomersToKaiBeachCafe_PlayerReturnsHomeExhausted[] =
        "I'm beat, too!\r\n"
        "Time to go home and sleep. {Press}";
};
