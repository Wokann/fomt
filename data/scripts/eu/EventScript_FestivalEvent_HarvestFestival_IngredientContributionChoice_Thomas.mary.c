...
mary_text_table
{
    const char gText_FestivalEvent_HarvestFestival_IngredientContributionChoice_Thomas_NoHeldItemOrDeclinedResponse[] =
        "It seems you don't have \r\n"
        "anything. You should bring\r\n"
        "something for the pot.{Press}";
...
void EventScript_FestivalEvent_HarvestFestival_IngredientContributionChoice_Thomas(void)
{
    ...
    if (IsPlayerHoldingNothing())
    {
        ...
        TalkMessage(gText_FestivalEvent_HarvestFestival_IngredientContributionChoice_Thomas_NoHeldItemOrDeclinedResponse);
        TalkClose();
    }
    else
    {
