...
mary_text_table
{
    const char gText_NPCEvent_Lillia_DialogueAndGiftResponses_Introduction[] =
        ...
        "Ah...I know, you're \r\n"
        "{Player}, right? \r\n"
        "Thomas mentioned you.{Press}\p"
        "I'm Lillia. Very nice\r\n"
        "to meet you!{Press}";
    ...
    const char gText_NPCEvent_Lillia_DialogueAndGiftResponses_AccessoryGiftResponse[] =
        "This is for me? Really?{Press}\p"
        "It's been a long time since\r\n"
        "a man gave me such a nice\r\n"
        "present! Tee-hee...{Press}";

    const char gText_NPCEvent_Lillia_DialogueAndGiftResponses_CosmeticGiftResponse[] =
        "This is for me...?\r\n"
        "Thanks...I'm flattered...{Press}";

    const char gText_NPCEvent_Lillia_DialogueAndGiftResponses_PerfumeGiftResponse[] =
        "Once, my husband went to\r\n"
        "town to get me some Perfume\r\n"
        "for my birthday, but he {Press}\r\n"
        "didn't come back until the\r\n"
        "birthday after that!{Press}";

    const char gText_NPCEvent_Lillia_DialogueAndGiftResponses_TeachesRecipeAfterAcceptedGift[] =
        "While I'm thinking of it,\r\n"
        "let me tell you the recipe\r\n"
        "for Scrambled Eggs. It's{Press}\p"
        "easy. All you do is put\r\n"
        "Oil in a Frying Pan, then\r\n"
        "put in the Eggs.{Press}\r\n"
        "That's it!{Press}\p"
        "But, it won't taste very\r\n"
        "good like that. {Press}\p"
        "Use a Whisk to fluff up \r\n"
        "the Eggs, or add Butter\r\n"
        "and Mayonnaise. Kids love{Press}\r\n"
        "it that way.{Press}\p"
        "Some people say you \r\n"
        "should only have one Egg\r\n"
        "per day, but I say eat {Press}\r\n"
        "all you want!{Press}";

    const char gText_NPCEvent_Lillia_DialogueAndGiftResponses_CommentsOnBlueFeatherAndRodsProposal[] =
        "Ah, a Blue Feather...{Press}\p"
        "My husband went off to look\r\n"
        "for one for me, but then \r\n"
        "didn't come back for a {Press}\r\n"
        "long time!{Press}";

    const char gText_NPCEvent_Lillia_DialogueAndGiftResponses_RodsLetter_FollowupLilliaDialogue[] =
        "My husband wrote me a \r\n"
        "while ago, saying he\r\n"
        "would write more letters.{Press}\p"
        "I wonder where\r\n"
        "he is now...?{Press}";

    const char gText_NPCEvent_Lillia_DialogueAndGiftResponses_PoultryFarmUpstairsRestingFirstConversation[] =
        "Oh, I'm sorry.\r\n"
        "When I'm taking a rest,\r\n"
        "the store has to be closed.{Press}\p"
        "My children are not home\r\n"
        "all the time, so only I\r\n"
        "can mind the store.{Press}";
    ...
    const char gText_NPCEvent_Lillia_DialogueAndGiftResponses_PopuriAfterChildbirthRepeatConversation[] =
        "Sasha says I look very\r\n"
        "young for my age and don’t\r\n"
        "look like a grandmother.{Press}";
    ...
    const char gText_NPCEvent_Lillia_DialogueAndGiftResponses_ClinicHighFriendshipRepeatConversation[] =
        "If I am reborn, I hope\r\n"
        "I become someone as healthy\r\n"
        "as you, {Player}!{Press}";
};
