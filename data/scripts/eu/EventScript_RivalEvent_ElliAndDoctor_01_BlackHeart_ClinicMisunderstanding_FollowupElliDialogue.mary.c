...
mary_text_table
{
    const char gText_RivalEvent_ElliAndDoctor_01_BlackHeart_ClinicMisunderstanding_FollowupElliDialogue_ElliSighsInDisappointment[] =
        "Hmmm......{Press}";
};

void EventScript_RivalEvent_ElliAndDoctor_01_BlackHeart_ClinicMisunderstanding_FollowupElliDialogue(void)
{
    ...
    TalkMessage(gText_RivalEvent_ElliAndDoctor_01_BlackHeart_ClinicMisunderstanding_FollowupElliDialogue_ElliSighsInDisappointment);
    TalkClose();
