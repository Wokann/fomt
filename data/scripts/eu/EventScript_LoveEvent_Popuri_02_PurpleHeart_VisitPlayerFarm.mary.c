...
mary_text_table
{
    const char gText_LoveEvent_Popuri_02_PurpleHeart_Popuri_AsksForFarmTour[] =
        "Good morning, \r\n"
        "{Player}.{Press}\p"
        "Today I came to look at \r\n"
        "your farm. Will you show \r\n"
        "me around?{Press}";
