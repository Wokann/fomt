...
void EventScript_FamilyEvent_Elli_PlayerBirthdayDinner(void)
{
    ...
    SetEntityEventScript(ENTITY_ELLI, EventScript_FamilyEvent_Elli_PlayerBirthdayDinnerDialogueChoice);
    if (VarGet(VAR_ELLI_CHILDBIRTH_EVENT_STATE) == EVENT_LIFECYCLE_COMPLETED)
    {
        SetEntityEventScript(ENTITY_CHILD, EventScript_FamilyEvent_Elli_PlayerBirthdayDinnerBabyGooGoo);
    }
