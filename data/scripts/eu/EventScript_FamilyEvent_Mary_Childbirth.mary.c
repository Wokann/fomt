...
mary_text_table
{
    ...
    const char gText_FamilyEvent_Mary_Childbirth_MaryMarvelsAtNewLifeAndRequestsName[] =
        ...
        "Nice to meet you, my son...{Press}\p"
        "We have to think of a name!\r\n"
        "Do you have any ideas?{Press}";
