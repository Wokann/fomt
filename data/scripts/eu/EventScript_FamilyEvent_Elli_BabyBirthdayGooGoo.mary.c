...
mary_text_table
{
    const char gText_FamilyEvent_Elli_BabyBirthdayGooGoo[] =
        "Goo-goo.{Press}";
};

void EventScript_FamilyEvent_Elli_BabyBirthdayGooGoo(void)
{
    ...
    TalkMessage(gText_FamilyEvent_Elli_BabyBirthdayGooGoo);
    TalkClose();
