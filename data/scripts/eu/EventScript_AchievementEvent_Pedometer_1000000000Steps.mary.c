...
mary_text_table
{
    const char gText_AchievementEvent_Pedometer_1000000000Steps[] =
        "Ta-daaaa!{Press}\p"
        "Your pedometer has just\r\n"
        "counted 1,000,000,000.{Press}\p"
...
void EventScript_AchievementEvent_Pedometer_1000000000Steps(void)
{
    VarSet(VAR_ACHIEVEMENT_WALKED_1000000000_STEPS_STATE, ACHIEVEMENT_EVENT_PRESENTING);
    ...
    TalkMessage(gText_AchievementEvent_Pedometer_1000000000Steps);
    TalkClose();
    MarkNpcSpokenTo(CHARACTER_HARVEST_GODDESS);
    AddCharacterLove(CHARACTER_HARVEST_GODDESS, 3000);
    VarSet(VAR_ACHIEVEMENT_WALKED_1000000000_STEPS_STATE, ACHIEVEMENT_EVENT_COMPLETED);
