...
mary_text_table
{
    const char gText_FestivalEvent_HarvestFestival_PreCookingDialogue_Ann[] =
        "Dad, don't be so picky!\r\n"
        "Just throw it all in!{Press}";
};

void EventScript_FestivalEvent_HarvestFestival_PreCookingDialogue_Ann(void)
{
    ...
    TalkMessage(gText_FestivalEvent_HarvestFestival_PreCookingDialogue_Ann);
    TalkClose();
