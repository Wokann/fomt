...
void EventScript_FamilyEvent_Popuri_BabyBirthday(void)
{
    ...
    SetEntityEventScript(ENTITY_POPURI, EventScript_FamilyEvent_Popuri_BabyBirthdayDateDialogueChoice);
    SetEntityEventScript(ENTITY_CHILD, EventScript_FamilyEvent_Popuri_BabyBirthdayGooGoo);
