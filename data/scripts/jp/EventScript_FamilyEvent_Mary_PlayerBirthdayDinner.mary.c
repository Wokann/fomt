...
void EventScript_FamilyEvent_Mary_PlayerBirthdayDinner(void)
{
    ...
    SetEntityEventScript(ENTITY_MARY, EventScript_FamilyEvent_Mary_PlayerBirthdayDinnerDialogueChoice);
    if (VarGet(VAR_MARY_CHILDBIRTH_EVENT_STATE) == EVENT_LIFECYCLE_COMPLETED)
    {
        SetEntityEventScript(ENTITY_CHILD, EventScript_FamilyEvent_Mary_PlayerBirthdayDinnerBabyGooGoo);
    }
