...
void EventScript_SystemMenu_RecipeBook(void)
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
                TalkOpen();
                var_0 = TalkChoice4(gText_SystemMenu_RecipeBook_KitchenRequired, gText_SystemMenu_RecipeBook_MenuPage1SixChoiceLayout, gText_SystemMenu_RecipeBook_MenuPage2SixChoiceLayout, gText_SystemMenu_RecipeBook_Exit);
                switch (var_0)
                {
                    case CHOICE_OPTION_1:
                        TalkClose();
            ...
            else
            {
                ...
                {
                    TalkOpen();
                    var_0 = TalkChoice5(gText_SystemMenu_RecipeBook_KitchenRequired, gText_SystemMenu_RecipeBook_MenuPage1SixChoiceLayout, gText_SystemMenu_RecipeBook_MenuPage2SixChoiceLayout, gText_SystemMenu_RecipeBook_MenuPage3SixChoiceLayout, gText_SystemMenu_RecipeBook_Exit);
                    switch (var_0)
                    {
                        case CHOICE_OPTION_1:
                            TalkClose();
