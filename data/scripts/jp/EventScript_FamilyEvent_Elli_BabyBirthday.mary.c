...
void EventScript_FamilyEvent_Elli_BabyBirthday(void)
{
    ...
    SetEntityEventScript(ENTITY_ELLI, EventScript_FamilyEvent_Elli_BabyBirthdayDateDialogueChoice);
    SetEntityEventScript(ENTITY_CHILD, EventScript_FamilyEvent_Elli_BabyBirthdayGooGoo);
