...
void EventScript_FamilyEvent_Mary_BabyBirthday(void)
{
    ...
    SetEntityEventScript(ENTITY_MARY, EventScript_FamilyEvent_Mary_BabyBirthdayDateDialogueChoice);
    SetEntityEventScript(ENTITY_CHILD, EventScript_FamilyEvent_Mary_BabyBirthdayGooGoo);
