...
mary_text_table
{
    const char gText_FamilyEvent_Mary_BabyBirthdayGooGoo[] =
        "だあ？{Press}";
};

void EventScript_FamilyEvent_Mary_BabyBirthdayGooGoo(void)
{
    ...
    TalkMessage(gText_FamilyEvent_Mary_BabyBirthdayGooGoo);
    TalkClose();
