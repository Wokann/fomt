...
mary_text_table
{
    ...
    const char gText_TV_ChannelDispatcher_LateNightCommonSignalInterferenceA[] =
        "－－－－－－－－－－－－－－\r\n"
        "－－－－－－－－－－－－－－\r\n"
        "－－－－－－－－－－－－－－{Press}";

    const char gText_TV_ChannelDispatcher_LateNightCommonSignalInterferenceB[] =
        "ピ－－－－－－－－－－－－－\r\n"
        "－－－－－－－－－－－－－－\r\n"
        "－－－－－－－－－－－－－－{Press}";
};
...
void EventScript_TV_ChannelDispatcher(void)
{
    ...
    if ((VarGet(VAR_HOUR) == 4 || VarGet(VAR_HOUR) == 16) && VarGet(VAR_MINUTE) == 44)
    {
        ...
        CallScript(EventScript_TV_4AMHiddenBroadcast);
    }
    else
    {
            ...
            if (VarGet(VAR_HOUR) < 6)
            {
                ...
                else
                {
                    ...
                    switch (var_0)
                    {
                        ...
                        case 4:
                        case 5:
                            var_1 = ShowTelevisionMessage(gText_TV_ChannelDispatcher_LateNightCommonSignalInterferenceA);
                            break;
                        case 6:
                        case 7:
                        case 8:
                        case 9:
                        case 10:
                            var_1 = ShowTelevisionMessage(gText_TV_ChannelDispatcher_LateNightCommonSignalInterferenceB);
                            break;
                    }
                }
            }
