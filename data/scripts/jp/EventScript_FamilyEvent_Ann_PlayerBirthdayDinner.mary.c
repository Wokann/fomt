...
void EventScript_FamilyEvent_Ann_PlayerBirthdayDinner(void)
{
    ...
    SetEntityEventScript(ENTITY_ANN, EventScript_FamilyEvent_Ann_PlayerBirthdayDinnerDialogueChoice);
    if (VarGet(VAR_ANN_CHILDBIRTH_EVENT_STATE) == EVENT_LIFECYCLE_COMPLETED)
    {
        SetEntityEventScript(ENTITY_CHILD, EventScript_FamilyEvent_Ann_PlayerBirthdayDinnerBabyGooGoo);
    }
