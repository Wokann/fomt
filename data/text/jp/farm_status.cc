...
char const gText_FarmStatus_CounterBirds[] =
    "羽";

char const gText_FarmStatus_CounterHeads[] =
    "頭";

char const gText_FarmStatus_CounterAnimals[] =
    "匹";

char const gText_FarmStatus_CounterSheets[] =
    "枚";

char const gText_FarmStatus_CounterPieces[] =
    "コ";

char const gText_FarmStatus_CounterLongObjects[] =
    "本";
...
char const gText_FarmStatus_DayUnit[] =
    "日";
...
char const gText_FarmStatus_MonthSuffix[] =
    "の月";
...
char const gText_FarmStatus_ToolUpgradeInProgress[] =
    "改造中";

char const gText_FarmStatus_ToolUpgradeAvailable[] =
    "改造可能";
