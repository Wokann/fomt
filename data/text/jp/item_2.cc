...
// JP article text. The build emits .align 2, 0 after every declaration.
...
char const gText_Item_Article_WoolX_Name[] =
    "羊毛Ｘサイズ";

char const gText_Item_Article_WoolX_Description[] =
    "羊毛Ｘサイズ\r\n"
    "羊から刈り取れる。\r\n"
    "";
...
char const gText_Item_Article_Album13_Description[] =
    "未使用アイテム\r\n"
    "一応じゃんけんで７０連勝以上\r\n"
    "するともらえる。";

char const gText_Item_Article_Album14_Name[] =
    "レコード１４";
