...
| EU | `0x080F19C0`–`0x080F1AC9` | `src/common_ui.o(.rodata)` | `src/common_ui.cc`、`include/common_ui.hh`、`data/text/eu/common_ui.cc`–`common_ui_6.cc`；固定文本槽中的空标签以直接符号重定位 | 精确 |
...
| EU | `0x080FE09C`–`0x080FE2AD` | `src/clinic_data.o(.rodata)` | `src/clinic_data.cc`、`include/clinic_data.hh`、`data/text/eu/clinic_data.cc`；目录表、9 项文本及运行时尾部字符串按 ROM 顺序同属该对象 | 精确 |
...
| EU | `0x080FEB40`–`0x080FECC5` | `src/beach_cafe_shop_data.o(.rodata)` | `src/beach_cafe_shop_data.cc`、`include/beach_cafe_shop_data.hh`、`data/text/eu/beach_cafe_shop_data.cc`、`data/text/eu/beach_cafe_shop_data_1.cc`；说明文本、菜单表、对话与运行时尾部字符串按 ROM 顺序同属该对象 | 精确 |
...
| DE | `0x080F1E5C`–`0x080F1F65` | `src/common_ui.o(.rodata)` | `src/common_ui.cc`、`include/common_ui.hh`、`data/text/de/common_ui.cc`–`common_ui_6.cc`；固定文本槽中的空标签以直接符号重定位 | 精确 |
...
| DE | `0x080FE7DC`–`0x080FEA21` | `src/clinic_data.o(.rodata)` | `src/clinic_data.cc`、`include/clinic_data.hh`、`data/text/de/clinic_data.cc`；目录表、9 项文本及运行时尾部字符串按 ROM 顺序同属该对象 | 精确 |
...
| `0x080EFD52`–`0x080EFD5D` | `src/game_state.o(.rodata)` | [嵌入文本 / 数据] | `src/game_state.cc`<br>`include/game_state.hh`<br>`data/text/jp/game_state.cc` | 固定季节行文本 `1` 项（保留必要的二字节起始对齐） |
| `0x080EFD5E`–`0x080EFD5F` | `*fill*` | [填充] | 链接脚本填充字节 `00` | 2 字节 |
| `0x080EFD60`–`0x080EFDCD` | `src/game_state.o(.rodata)` | [嵌入文本 / 数据] | `src/game_state.cc`<br>`include/game_state.hh`<br>`data/text/jp/game_state.cc`<br>`data/text/jp/game_state_1.cc` | 文本 `3` 项（详见下方索引）<br>运行时字符串 `5` 项<br>`gUnk_080F0566`（普通数据）<br>尾部运行时文本 `1` 项 |
...
| `0x080F11D4`–`0x080F12D9` | `src/common_ui.o(.rodata)` | [嵌入文本 / 数据] | `src/common_ui.cc`<br>`include/common_ui.hh`<br>`data/text/jp/common_ui.cc`–`common_ui_6.cc` | 文本 `12` 项（详见下方索引）<br>运行时字符串 `6` 项<br>`gText_EmptyUiLabel`、`gUnk_080F19AE`、`gMenuEntryIds`、`gMenuEntryLabels`、`gUnk_080F1A66`<br>固定容量文本槽保留原始字节；所有汇编读取均为直接符号重定位；下方起点约束此可本地化范围 |
...
| `0x080F2C14`–`0x080F822F` | `src/entity_ui_resource_selector.o(.rodata)` | [嵌入文本 / 数据] | `src/entity_ui_resource_selector.cc`<br>`include/entity_ui_resource_selector.hh`<br>`data/text/jp/entity_ui_resource_selector.cc`–`entity_ui_resource_selector_23.cc` | 运行时字符串 `24` 项<br>25 个连续选择器描述符（由 `gUnk_080F33B8` 至 `gUnk_080F8678` 的物理顺序组成）<br>顶层描述符、表、条目、载荷、详情记录与运行时文本均由同名头文件声明；内部和外部调用均为符号重定位 |
...
| `0x080FD810`–`0x080FD9E1` | `src/clinic_data.o(.rodata)` | [嵌入文本 / 数据] | `src/clinic_data.cc`<br>`include/clinic_data.hh`<br>`data/text/jp/clinic_data.cc` | `gClinicCatalog`<br>文本 `9` 项（详见下方索引）<br>运行时字符串 `1` 项 |
...
| `0x080FE3A0`–`0x080FE539` | `src/beach_cafe_shop_data.o(.rodata)` | [嵌入文本 / 数据] | `src/beach_cafe_shop_data.cc`<br>`include/beach_cafe_shop_data.hh`<br>`data/text/jp/beach_cafe_shop_data.cc`<br>`data/text/jp/beach_cafe_shop_data_1.cc` | 说明文本 `4` 项<br>`gBeachCafeShopMenu`<br>对话文本 `3` 项<br>运行时字符串 `1` 项 |
...
| `0x080E8B60` | `gText_Item_Tool_CopperSickle_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8BA4` | `gText_Item_Tool_SilverSickle_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8BB0` | `gText_Item_Tool_SilverSickle_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8BF4` | `gText_Item_Tool_GoldSickle_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8C00` | `gText_Item_Tool_GoldSickle_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8C44` | `gText_Item_Tool_MystrileSickle_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8C54` | `gText_Item_Tool_MystrileSickle_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8C9C` | `gText_Item_Tool_CursedSickle_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8CAC` | `gText_Item_Tool_CursedSickle_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8CF4` | `gText_Item_Tool_BlessedSickle_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8D00` | `gText_Item_Tool_BlessedSickle_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8D24` | `gText_Item_Tool_MythicSickle_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8D30` | `gText_Item_Tool_MythicSickle_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8D74` | `gText_Item_Tool_IronHoe_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8D80` | `gText_Item_Tool_IronHoe_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8DC0` | `gText_Item_Tool_CopperHoe_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8DCC` | `gText_Item_Tool_CopperHoe_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8E10` | `gText_Item_Tool_SilverHoe_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8E1C` | `gText_Item_Tool_SilverHoe_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8E60` | `gText_Item_Tool_GoldHoe_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8E6C` | `gText_Item_Tool_GoldHoe_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8EB0` | `gText_Item_Tool_MystrileHoe_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8EC0` | `gText_Item_Tool_MystrileHoe_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8F0C` | `gText_Item_Tool_CursedHoe_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8F1C` | `gText_Item_Tool_CursedHoe_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8F64` | `gText_Item_Tool_BlessedHoe_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8F70` | `gText_Item_Tool_BlessedHoe_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8F94` | `gText_Item_Tool_MythicHoe_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8FA0` | `gText_Item_Tool_MythicHoe_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8FE8` | `gText_Item_Tool_IronAxe_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E8FF4` | `gText_Item_Tool_IronAxe_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9028` | `gText_Item_Tool_CopperAxe_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9034` | `gText_Item_Tool_CopperAxe_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9064` | `gText_Item_Tool_SilverAxe_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9070` | `gText_Item_Tool_SilverAxe_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E90A0` | `gText_Item_Tool_GoldAxe_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E90AC` | `gText_Item_Tool_GoldAxe_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E90DC` | `gText_Item_Tool_MystrileAxe_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E90EC` | `gText_Item_Tool_MystrileAxe_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9120` | `gText_Item_Tool_CursedAxe_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9130` | `gText_Item_Tool_CursedAxe_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9178` | `gText_Item_Tool_BlessedAxe_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9184` | `gText_Item_Tool_BlessedAxe_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E91A8` | `gText_Item_Tool_MythicAxe_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E91B4` | `gText_Item_Tool_MythicAxe_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E91E4` | `gText_Item_Tool_IronHammer_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E91F4` | `gText_Item_Tool_IronHammer_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E923C` | `gText_Item_Tool_CopperHammer_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E924C` | `gText_Item_Tool_CopperHammer_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9298` | `gText_Item_Tool_SilverHammer_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E92A8` | `gText_Item_Tool_SilverHammer_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E92EC` | `gText_Item_Tool_GoldHammer_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E92FC` | `gText_Item_Tool_GoldHammer_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9340` | `gText_Item_Tool_MystrileHammer_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9354` | `gText_Item_Tool_MystrileHammer_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E939C` | `gText_Item_Tool_CursedHammer_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E93B0` | `gText_Item_Tool_CursedHammer_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E93FC` | `gText_Item_Tool_BlessedHammer_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E940C` | `gText_Item_Tool_BlessedHammer_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9438` | `gText_Item_Tool_MythicHammer_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9448` | `gText_Item_Tool_MythicHammer_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E948C` | `gText_Item_Tool_WateringCan_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9498` | `gText_Item_Tool_WateringCan_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E94B0` | `gText_Item_Tool_CopperWateringCan_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E94C0` | `gText_Item_Tool_CopperWateringCan_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E94DC` | `gText_Item_Tool_SilverWateringCan_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E94EC` | `gText_Item_Tool_SilverWateringCan_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9508` | `gText_Item_Tool_GoldWateringCan_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9518` | `gText_Item_Tool_GoldWateringCan_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9534` | `gText_Item_Tool_MystrileWateringCan_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9548` | `gText_Item_Tool_MystrileWateringCan_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E956C` | `gText_Item_Tool_CursedWateringCan_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9580` | `gText_Item_Tool_CursedWateringCan_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E95CC` | `gText_Item_Tool_BlessedWateringCan_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E95DC` | `gText_Item_Tool_BlessedWateringCan_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9608` | `gText_Item_Tool_MythicWateringCan_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9618` | `gText_Item_Tool_MythicWateringCan_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9638` | `gText_Item_Tool_FishingRod_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9640` | `gText_Item_Tool_FishingRod_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9658` | `gText_Item_Tool_CopperFishingRod_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9664` | `gText_Item_Tool_CopperFishingRod_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9684` | `gText_Item_Tool_SilverFishingRod_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9690` | `gText_Item_Tool_SilverFishingRod_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E96B0` | `gText_Item_Tool_GoldFishingRod_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E96BC` | `gText_Item_Tool_GoldFishingRod_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E96DC` | `gText_Item_Tool_MystrileFishingRod_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E96F0` | `gText_Item_Tool_MystrileFishingRod_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9714` | `gText_Item_Tool_CursedFishingRod_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9724` | `gText_Item_Tool_CursedFishingRod_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E976C` | `gText_Item_Tool_BlessedFishingRod_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E977C` | `gText_Item_Tool_BlessedFishingRod_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E97A4` | `gText_Item_Tool_MythicFishingRod_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E97B4` | `gText_Item_Tool_MythicFishingRod_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E97D4` | `gText_Item_Tool_CowMiraclePotion_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E97E0` | `gText_Item_Tool_CowMiraclePotion_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9814` | `gText_Item_Tool_SheepMiraclePotion_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9820` | `gText_Item_Tool_SheepMiraclePotion_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9854` | `gText_Item_Tool_TurnipSeeds_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9860` | `gText_Item_Tool_TurnipSeeds_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E987C` | `gText_Item_Tool_PotatoSeeds_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E988C` | `gText_Item_Tool_PotatoSeeds_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E98B0` | `gText_Item_Tool_CucumberSeeds_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E98C0` | `gText_Item_Tool_CucumberSeeds_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E98E0` | `gText_Item_Tool_StrawberrySeeds_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E98EC` | `gText_Item_Tool_StrawberrySeeds_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E990C` | `gText_Item_Tool_CabbageSeeds_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E991C` | `gText_Item_Tool_CabbageSeeds_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E993C` | `gText_Item_Tool_TomatoSeeds_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9948` | `gText_Item_Tool_TomatoSeeds_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9968` | `gText_Item_Tool_CornSeeds_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E997C` | `gText_Item_Tool_CornSeeds_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E99A0` | `gText_Item_Tool_OnionSeeds_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E99B0` | `gText_Item_Tool_OnionSeeds_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E99D0` | `gText_Item_Tool_PumpkinSeeds_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E99E0` | `gText_Item_Tool_PumpkinSeeds_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9A00` | `gText_Item_Tool_PineappleSeeds_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9A14` | `gText_Item_Tool_PineappleSeeds_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9A38` | `gText_Item_Tool_EggplantSeeds_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9A44` | `gText_Item_Tool_EggplantSeeds_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9A60` | `gText_Item_Tool_CarrotSeeds_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9A70` | `gText_Item_Tool_CarrotSeeds_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9A90` | `gText_Item_Tool_SweetPotatoSeeds_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9AA0` | `gText_Item_Tool_SweetPotatoSeeds_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9AC4` | `gText_Item_Tool_SpinachSeeds_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9AD8` | `gText_Item_Tool_SpinachSeeds_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9AFC` | `gText_Item_Tool_GreenPepperSeeds_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9B0C` | `gText_Item_Tool_GreenPepperSeeds_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9B2C` | `gText_Item_Tool_GrassSeeds_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9B38` | `gText_Item_Tool_GrassSeeds_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9B60` | `gText_Item_Tool_MoonDropSeeds_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9B74` | `gText_Item_Tool_MoonDropSeeds_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9B9C` | `gText_Item_Tool_PinkCatSeeds_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9BB0` | `gText_Item_Tool_PinkCatSeeds_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9BD8` | `gText_Item_Tool_MagicSeeds_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9BEC` | `gText_Item_Tool_MagicSeeds_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9C14` | `gText_Item_Tool_ToyFlowerSeeds_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9C28` | `gText_Item_Tool_ToyFlowerSeeds_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9C4C` | `gText_Item_Tool_Brush_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9C54` | `gText_Item_Tool_Brush_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9C90` | `gText_Item_Tool_Milker_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9C9C` | `gText_Item_Tool_Milker_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9CD8` | `gText_Item_Tool_Clipper_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9CE8` | `gText_Item_Tool_Clipper_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9D2C` | `gText_Item_Tool_Bell_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9D34` | `gText_Item_Tool_Bell_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9D5C` | `gText_Item_Tool_AnimalMedicine_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9D68` | `gText_Item_Tool_AnimalMedicine_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9D8C` | `gText_Item_Tool_BlueFeather_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9D98` | `gText_Item_Tool_BlueFeather_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9DD0` | `gText_Item_Tool_Pedometer_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9DD8` | `gText_Item_Tool_Pedometer_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9DE4` | `gText_Item_Tool_TeleportStone_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9DEC` | `gText_Item_Tool_TeleportStone_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9E1C` | `gText_Item_Tool_GemOfTheGoddess_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9E28` | `gText_Item_Tool_GemOfTheGoddess_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9E60` | `gText_Item_Tool_GemOfTheKappa_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9E70` | `gText_Item_Tool_GemOfTheKappa_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9EA8` | `gText_Item_Tool_GemOfTruth_Name` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080E9EB4` | `gText_Item_Tool_GemOfTruth_Description` | `data/text/jp/item.cc` | `src/item.o(.rodata)` |
| `0x080EA2B8` | `gText_Item_Food_Turnip_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA2C0` | `gText_Item_Food_Turnip_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA2E8` | `gText_Item_Food_Potato_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA2F4` | `gText_Item_Food_Potato_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA320` | `gText_Item_Food_Cucumber_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA32C` | `gText_Item_Food_Cucumber_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA358` | `gText_Item_Food_Strawberry_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA360` | `gText_Item_Food_Strawberry_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA388` | `gText_Item_Food_Cabbage_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA394` | `gText_Item_Food_Cabbage_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA3C0` | `gText_Item_Food_Tomato_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA3C8` | `gText_Item_Food_Tomato_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA3F0` | `gText_Item_Food_Corn_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA400` | `gText_Item_Food_Corn_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA430` | `gText_Item_Food_Onion_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA43C` | `gText_Item_Food_Onion_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA468` | `gText_Item_Food_Pumpkin_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA474` | `gText_Item_Food_Pumpkin_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA4A0` | `gText_Item_Food_Pineapple_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA4B0` | `gText_Item_Food_Pineapple_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA4E0` | `gText_Item_Food_Eggplant_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA4E8` | `gText_Item_Food_Eggplant_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA510` | `gText_Item_Food_Carrot_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA51C` | `gText_Item_Food_Carrot_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA548` | `gText_Item_Food_SweetPotato_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA554` | `gText_Item_Food_SweetPotato_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA580` | `gText_Item_Food_Spinach_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA590` | `gText_Item_Food_Spinach_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA5C0` | `gText_Item_Food_GreenPepper_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA5CC` | `gText_Item_Food_GreenPepper_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA5F8` | `gText_Item_Food_RegularQualityEgg_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA608` | `gText_Item_Food_RegularQualityEgg_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA644` | `gText_Item_Food_GoodQualityEgg_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA654` | `gText_Item_Food_GoodQualityEgg_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA68C` | `gText_Item_Food_HighQualityEgg_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA6A0` | `gText_Item_Food_HighQualityEgg_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA6E0` | `gText_Item_Food_GoldenEgg_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA6E8` | `gText_Item_Food_GoldenEgg_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA71C` | `gText_Item_Food_PEgg_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA724` | `gText_Item_Food_PEgg_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA758` | `gText_Item_Food_XEgg_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA760` | `gText_Item_Food_XEgg_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA794` | `gText_Item_Food_SpaboiledEgg_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA79C` | `gText_Item_Food_SpaboiledEgg_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA7E0` | `gText_Item_Food_MayonnaiseS_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA7F4` | `gText_Item_Food_MayonnaiseS_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA834` | `gText_Item_Food_MayonnaiseM_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA848` | `gText_Item_Food_MayonnaiseM_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA888` | `gText_Item_Food_MayonnaiseL_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA89C` | `gText_Item_Food_MayonnaiseL_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA8DC` | `gText_Item_Food_MayonnaiseG_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA8F0` | `gText_Item_Food_MayonnaiseG_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA930` | `gText_Item_Food_MayonnaiseP_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA944` | `gText_Item_Food_MayonnaiseP_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA984` | `gText_Item_Food_MayonnaiseX_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA998` | `gText_Item_Food_MayonnaiseX_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA9D8` | `gText_Item_Food_MilkS_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EA9E8` | `gText_Item_Food_MilkS_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAA28` | `gText_Item_Food_MilkM_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAA38` | `gText_Item_Food_MilkM_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAA78` | `gText_Item_Food_MilkL_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAA88` | `gText_Item_Food_MilkL_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAAC8` | `gText_Item_Food_MilkG_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAAD8` | `gText_Item_Food_MilkG_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAB18` | `gText_Item_Food_MilkP_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAB28` | `gText_Item_Food_MilkP_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAB68` | `gText_Item_Food_MilkX_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAB78` | `gText_Item_Food_MilkX_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EABB8` | `gText_Item_Food_CheeseS_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EABC8` | `gText_Item_Food_CheeseS_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAC04` | `gText_Item_Food_CheeseM_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAC14` | `gText_Item_Food_CheeseM_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAC50` | `gText_Item_Food_CheeseL_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAC60` | `gText_Item_Food_CheeseL_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAC9C` | `gText_Item_Food_CheeseG_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EACAC` | `gText_Item_Food_CheeseG_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EACE8` | `gText_Item_Food_CheeseP_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EACF8` | `gText_Item_Food_CheeseP_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAD34` | `gText_Item_Food_CheeseX_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAD44` | `gText_Item_Food_CheeseX_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAD80` | `gText_Item_Food_Apple_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAD88` | `gText_Item_Food_Apple_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EADC4` | `gText_Item_Food_Honey_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EADD0` | `gText_Item_Food_Honey_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAE10` | `gText_Item_Food_BambooShoot_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAE1C` | `gText_Item_Food_BambooShoot_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAE5C` | `gText_Item_Food_WildGrapes_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAE6C` | `gText_Item_Food_WildGrapes_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAEB0` | `gText_Item_Food_Mushroom_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAEB8` | `gText_Item_Food_Mushroom_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAEF8` | `gText_Item_Food_PoisonousMushroom_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAF04` | `gText_Item_Food_PoisonousMushroom_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAF48` | `gText_Item_Food_Truffle_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAF54` | `gText_Item_Food_Truffle_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAF8C` | `gText_Item_Food_BlueGrass_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAF94` | `gText_Item_Food_BlueGrass_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAFD0` | `gText_Item_Food_GreenGrass_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAFD8` | `gText_Item_Food_GreenGrass_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB014` | `gText_Item_Food_RedGrass_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB01C` | `gText_Item_Food_RedGrass_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB05C` | `gText_Item_Food_YellowGrass_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB064` | `gText_Item_Food_YellowGrass_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB0A8` | `gText_Item_Food_OrangeGrass_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB0B0` | `gText_Item_Food_OrangeGrass_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB0F0` | `gText_Item_Food_PurpleGrass_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB0F8` | `gText_Item_Food_PurpleGrass_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB13C` | `gText_Item_Food_IndigoGrass_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB144` | `gText_Item_Food_IndigoGrass_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB17C` | `gText_Item_Food_BlackGrass_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB184` | `gText_Item_Food_BlackGrass_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB1C8` | `gText_Item_Food_WhiteGrass_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB1D0` | `gText_Item_Food_WhiteGrass_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB214` | `gText_Item_Food_QueenOfTheNight_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB220` | `gText_Item_Food_QueenOfTheNight_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB25C` | `gText_Item_Food_Bodigizer_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB26C` | `gText_Item_Food_Bodigizer_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB290` | `gText_Item_Food_BodigizerXl_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB2A4` | `gText_Item_Food_BodigizerXl_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB2D4` | `gText_Item_Food_Turbojolt_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB2E4` | `gText_Item_Food_Turbojolt_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB308` | `gText_Item_Food_TurbojoltXl_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB31C` | `gText_Item_Food_TurbojoltXl_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB34C` | `gText_Item_Food_Wine_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB354` | `gText_Item_Food_Wine_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB38C` | `gText_Item_Food_GrapeJuice_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB39C` | `gText_Item_Food_GrapeJuice_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB3E0` | `gText_Item_Food_RiceBall_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB3EC` | `gText_Item_Food_RiceBall_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB424` | `gText_Item_Food_Bread_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB42C` | `gText_Item_Food_Bread_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB460` | `gText_Item_Food_Oil_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB464` | `gText_Item_Food_Oil_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB494` | `gText_Item_Food_Flower_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB49C` | `gText_Item_Food_Flower_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB4D0` | `gText_Item_Food_CurryPowder_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB4DC` | `gText_Item_Food_CurryPowder_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB514` | `gText_Item_Food_MuffinMix_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB520` | `gText_Item_Food_MuffinMix_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB558` | `gText_Item_Food_Chocolate_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB568` | `gText_Item_Food_Chocolate_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB5A4` | `gText_Item_Food_RelaxTeaLeaves_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB5B8` | `gText_Item_Food_RelaxTeaLeaves_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB5F4` | `gText_Item_Food_SugdwApple_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB608` | `gText_Item_Food_SugdwApple_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB65C` | `gText_Item_Food_HmsgbApple_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB670` | `gText_Item_Food_HmsgbApple_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB6CC` | `gText_Item_Food_AepfeApple_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB6E0` | `gText_Item_Food_AepfeApple_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB738` | `gText_Item_Food_BuckwheatFlour_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB740` | `gText_Item_Food_BuckwheatFlour_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB774` | `gText_Item_Food_WildGrapeJuice_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB780` | `gText_Item_Food_WildGrapeJuice_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB7B0` | `gText_Item_Food_Salad_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB7B8` | `gText_Item_Food_Salad_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB7F4` | `gText_Item_Food_CurryRice_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB804` | `gText_Item_Food_CurryRice_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB84C` | `gText_Item_Food_Stew_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB858` | `gText_Item_Food_Stew_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB89C` | `gText_Item_Food_MisoSoup_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB8A4` | `gText_Item_Food_MisoSoup_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB8E0` | `gText_Item_Food_StirFry_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB8EC` | `gText_Item_Food_StirFry_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB92C` | `gText_Item_Food_FriedRice_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB938` | `gText_Item_Food_FriedRice_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB978` | `gText_Item_Food_SavoryPancake_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB984` | `gText_Item_Food_SavoryPancake_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB9C4` | `gText_Item_Food_Sandwich_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB9D4` | `gText_Item_Food_Sandwich_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBA20` | `gText_Item_Food_FruitJuice_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBA34` | `gText_Item_Food_FruitJuice_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBA74` | `gText_Item_Food_VegetableJuice_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBA84` | `gText_Item_Food_VegetableJuice_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBAC0` | `gText_Item_Food_MixedJuice_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBAD4` | `gText_Item_Food_MixedJuice_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBB1C` | `gText_Item_Food_FruitLatte_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBB30` | `gText_Item_Food_FruitLatte_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBB78` | `gText_Item_Food_VegetableLatte_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBB88` | `gText_Item_Food_VegetableLatte_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBBCC` | `gText_Item_Food_MixedLatte_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBBE0` | `gText_Item_Food_MixedLatte_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBC28` | `gText_Item_Food_StrawberryMilk_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBC34` | `gText_Item_Food_StrawberryMilk_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBC78` | `gText_Item_Food_StrawberryJam_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBC88` | `gText_Item_Food_StrawberryJam_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBCCC` | `gText_Item_Food_TomatoJuice_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBCDC` | `gText_Item_Food_TomatoJuice_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBD1C` | `gText_Item_Food_PickledTurnip_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBD2C` | `gText_Item_Food_PickledTurnip_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBD6C` | `gText_Item_Food_FrenchFries_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBD7C` | `gText_Item_Food_FrenchFries_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBDC4` | `gText_Item_Food_Pickles_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBDD8` | `gText_Item_Food_Pickles_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBE20` | `gText_Item_Food_Ketchup_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBE2C` | `gText_Item_Food_Ketchup_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBE6C` | `gText_Item_Food_Popcorn_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBE7C` | `gText_Item_Food_Popcorn_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBEC4` | `gText_Item_Food_CornFlakes_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBED4` | `gText_Item_Food_CornFlakes_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBF20` | `gText_Item_Food_BakedCorn_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBF34` | `gText_Item_Food_BakedCorn_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBF80` | `gText_Item_Food_PineappleJuice_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBF90` | `gText_Item_Food_PineappleJuice_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBFD8` | `gText_Item_Food_PumpkinPudding_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBFE8` | `gText_Item_Food_PumpkinPudding_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC030` | `gText_Item_Food_PumpkinStew_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC044` | `gText_Item_Food_PumpkinStew_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC08C` | `gText_Item_Food_HappyEggplant_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC098` | `gText_Item_Food_HappyEggplant_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC0D4` | `gText_Item_Food_SweetPotatoes_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC0E4` | `gText_Item_Food_SweetPotatoes_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC12C` | `gText_Item_Food_BakedSweetPotato_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC138` | `gText_Item_Food_BakedSweetPotato_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC17C` | `gText_Item_Food_Greens_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC188` | `gText_Item_Food_Greens_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC1CC` | `gText_Item_Food_ScrambledEggs_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC1D4` | `gText_Item_Food_ScrambledEggs_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC20C` | `gText_Item_Food_Omelet_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC218` | `gText_Item_Food_Omelet_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC254` | `gText_Item_Food_OmeletRice_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC260` | `gText_Item_Food_OmeletRice_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC29C` | `gText_Item_Food_BoiledEgg_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC2A4` | `gText_Item_Food_BoiledEgg_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC2DC` | `gText_Item_Food_HotMilk_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC2EC` | `gText_Item_Food_HotMilk_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC328` | `gText_Item_Food_Butter_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC330` | `gText_Item_Food_Butter_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC36C` | `gText_Item_Food_CheeseCake_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC37C` | `gText_Item_Food_CheeseCake_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC3C0` | `gText_Item_Food_CheeseFondue_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC3D4` | `gText_Item_Food_CheeseFondue_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC41C` | `gText_Item_Food_ApplePie_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC42C` | `gText_Item_Food_ApplePie_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC46C` | `gText_Item_Food_AppleJam_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC47C` | `gText_Item_Food_AppleJam_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC4C0` | `gText_Item_Food_AppleSouffl_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC4CC` | `gText_Item_Food_AppleSouffl_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC50C` | `gText_Item_Food_MushroomRice_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC51C` | `gText_Item_Food_MushroomRice_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC560` | `gText_Item_Food_BambooRice_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC570` | `gText_Item_Food_BambooRice_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC5B8` | `gText_Item_Food_TruffleRice_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC5C8` | `gText_Item_Food_TruffleRice_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC610` | `gText_Item_Food_Sushi_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC618` | `gText_Item_Food_Sushi_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC658` | `gText_Item_Food_JamBun_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC664` | `gText_Item_Food_JamBun_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC6A4` | `gText_Item_Food_DinnerRole_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC6B4` | `gText_Item_Food_DinnerRole_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC6F4` | `gText_Item_Food_RaisinBread_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC700` | `gText_Item_Food_RaisinBread_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC740` | `gText_Item_Food_GrapeJam_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC750` | `gText_Item_Food_GrapeJam_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC794` | `gText_Item_Food_CurryBread_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC7A0` | `gText_Item_Food_CurryBread_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC7E0` | `gText_Item_Food_Sashimi_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC7E8` | `gText_Item_Food_Sashimi_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC824` | `gText_Item_Food_GrilledFish_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC82C` | `gText_Item_Food_GrilledFish_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC864` | `gText_Item_Food_ChirashiSushi_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC870` | `gText_Item_Food_ChirashiSushi_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC8B8` | `gText_Item_Food_Pizza_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC8C0` | `gText_Item_Food_Pizza_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC8F8` | `gText_Item_Food_Noodles_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC900` | `gText_Item_Food_Noodles_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC944` | `gText_Item_Food_CurryNoodles_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC954` | `gText_Item_Food_CurryNoodles_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC998` | `gText_Item_Food_TempuraNoodles_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC9A8` | `gText_Item_Food_TempuraNoodles_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC9EC` | `gText_Item_Food_FriedNoodles_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC9F8` | `gText_Item_Food_FriedNoodles_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECA38` | `gText_Item_Food_BuckwheatNoodles_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECA44` | `gText_Item_Food_BuckwheatNoodles_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECA80` | `gText_Item_Food_NoodlesWTempura_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECA8C` | `gText_Item_Food_NoodlesWTempura_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECACC` | `gText_Item_Food_FriedBuckwheatNoodles_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECAD8` | `gText_Item_Food_FriedBuckwheatNoodles_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECB14` | `gText_Item_Food_BuckwheatChips_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECB20` | `gText_Item_Food_BuckwheatChips_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECB5C` | `gText_Item_Food_Cookies_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECB68` | `gText_Item_Food_Cookies_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECBA8` | `gText_Item_Food_ChocolateCookies_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECBB8` | `gText_Item_Food_ChocolateCookies_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECC00` | `gText_Item_Food_Tempura_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECC08` | `gText_Item_Food_Tempura_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECC4C` | `gText_Item_Food_IceCream_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECC5C` | `gText_Item_Food_IceCream_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECC94` | `gText_Item_Food_Cake_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECC9C` | `gText_Item_Food_Cake_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECCD0` | `gText_Item_Food_ChocolateCake_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECCE4` | `gText_Item_Food_ChocolateCake_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECD24` | `gText_Item_Food_RelaxationTea_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECD38` | `gText_Item_Food_RelaxationTea_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECD78` | `gText_Item_Food_Toast_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECD84` | `gText_Item_Food_Toast_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECDC0` | `gText_Item_Food_FrenchToast_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECDD4` | `gText_Item_Food_FrenchToast_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECE18` | `gText_Item_Food_Pudding_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECE20` | `gText_Item_Food_Pudding_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECE54` | `gText_Item_Food_MountainStew_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECE60` | `gText_Item_Food_MountainStew_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECE9C` | `gText_Item_Food_MoonDumplings_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECEA8` | `gText_Item_Food_MoonDumplings_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECEF0` | `gText_Item_Food_RiceCake_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECEF8` | `gText_Item_Food_RiceCake_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECF38` | `gText_Item_Food_RoastedRiceCake_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECF44` | `gText_Item_Food_RoastedRiceCake_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECF84` | `gText_Item_Food_ElliLeaves_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECF8C` | `gText_Item_Food_ElliLeaves_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECFD0` | `gText_Item_Food_FailedDish_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECFE8` | `gText_Item_Food_FailedDish_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED01C` | `gText_Item_Food_FailedDrink_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED02C` | `gText_Item_Food_FailedPotDish_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED044` | `gText_Item_Food_FailedDessert_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED054` | `gText_Item_Food_FailedBread_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED064` | `gText_Item_Food_FailedNoodles_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED074` | `gText_Item_Food_SmallFish_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED07C` | `gText_Item_Food_SmallFish_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED0C0` | `gText_Item_Food_MediumFish_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED0C8` | `gText_Item_Food_MediumFish_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED10C` | `gText_Item_Food_LargeFish_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED114` | `gText_Item_Food_LargeFish_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED158` | `gText_Item_Food_ToastedRiceBall_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED168` | `gText_Item_Food_ToastedRiceBall_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED1AC` | `gText_Item_Food_TempuraRice_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED1B8` | `gText_Item_Food_TempuraRice_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED1FC` | `gText_Item_Food_EggOverRice_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED208` | `gText_Item_Food_EggOverRice_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED248` | `gText_Item_Food_RiceGruel_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED250` | `gText_Item_Food_RiceGruel_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED294` | `gText_Item_Food_Pancakes_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED2A4` | `gText_Item_Food_Pancakes_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED2E8` | `gText_Item_Food_FishSticks_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED2F4` | `gText_Item_Food_FishSticks_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED338` | `gText_Item_Food_CandiedPotato_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED344` | `gText_Item_Food_CandiedPotato_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED388` | `gText_Item_Food_PotatoPancakes_Name` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED394` | `gText_Item_Food_PotatoPancakes_Description` | `data/text/jp/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EDE88` | `gText_Item_Article_MoonDropGrass_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EDE9C` | `gText_Item_Article_MoonDropGrass_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EDED0` | `gText_Item_Article_PinkCatGrass_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EDEE4` | `gText_Item_Article_PinkCatGrass_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EDF18` | `gText_Item_Article_BlueMagicGrass_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EDF30` | `gText_Item_Article_BlueMagicGrass_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EDF68` | `gText_Item_Article_RedMagicGrass_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EDF80` | `gText_Item_Article_RedMagicGrass_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EDFB4` | `gText_Item_Article_ToyFlower_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EDFC4` | `gText_Item_Article_ToyFlower_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EDFF4` | `gText_Item_Article_WoolS_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE004` | `gText_Item_Article_WoolS_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE028` | `gText_Item_Article_WoolM_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE038` | `gText_Item_Article_WoolM_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE05C` | `gText_Item_Article_WoolL_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE06C` | `gText_Item_Article_WoolL_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE090` | `gText_Item_Article_WoolG_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE0A0` | `gText_Item_Article_WoolG_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE0C4` | `gText_Item_Article_WoolP_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE0D4` | `gText_Item_Article_WoolP_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE0F8` | `gText_Item_Article_WoolX_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE108` | `gText_Item_Article_WoolX_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE12C` | `gText_Item_Article_YarnS_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE13C` | `gText_Item_Article_YarnS_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE178` | `gText_Item_Article_YarnM_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE188` | `gText_Item_Article_YarnM_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE1C4` | `gText_Item_Article_YarnL_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE1D4` | `gText_Item_Article_YarnL_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE210` | `gText_Item_Article_YarnG_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE220` | `gText_Item_Article_YarnG_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE25C` | `gText_Item_Article_YarnP_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE26C` | `gText_Item_Article_YarnP_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE2A8` | `gText_Item_Article_YarnX_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE2B8` | `gText_Item_Article_YarnX_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE2F4` | `gText_Item_Article_JunkOre_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE300` | `gText_Item_Article_JunkOre_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE348` | `gText_Item_Article_Copper_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE34C` | `gText_Item_Article_Copper_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE388` | `gText_Item_Article_Silver_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE38C` | `gText_Item_Article_Silver_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE3C8` | `gText_Item_Article_Gold_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE3CC` | `gText_Item_Article_Gold_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE408` | `gText_Item_Article_Mystrile_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE414` | `gText_Item_Article_Mystrile_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE454` | `gText_Item_Article_Orichalc_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE464` | `gText_Item_Article_Orichalc_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE4AC` | `gText_Item_Article_Adamantite_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE4BC` | `gText_Item_Article_Adamantite_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE508` | `gText_Item_Article_MoonStone_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE518` | `gText_Item_Article_MoonStone_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE550` | `gText_Item_Article_SandRose_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE560` | `gText_Item_Article_SandRose_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE598` | `gText_Item_Article_PinkDiamond_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE5AC` | `gText_Item_Article_PinkDiamond_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE5F0` | `gText_Item_Article_Alexandrite_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE604` | `gText_Item_Article_Alexandrite_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE648` | `gText_Item_Article_MythicStone_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE654` | `gText_Item_Article_MythicStone_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE69C` | `gText_Item_Article_Diamond_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE6AC` | `gText_Item_Article_Diamond_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE6E8` | `gText_Item_Article_Emerald_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE6F4` | `gText_Item_Article_Emerald_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE730` | `gText_Item_Article_Ruby_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE738` | `gText_Item_Article_Ruby_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE768` | `gText_Item_Article_Topaz_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE774` | `gText_Item_Article_Topaz_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE7A8` | `gText_Item_Article_Peridot_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE7B4` | `gText_Item_Article_Peridot_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE7E8` | `gText_Item_Article_Fluorite_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE7F0` | `gText_Item_Article_Fluorite_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE820` | `gText_Item_Article_Agate_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE828` | `gText_Item_Article_Agate_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE858` | `gText_Item_Article_Amethyst_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE864` | `gText_Item_Article_Amethyst_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE898` | `gText_Item_Article_HarvestGoddessJewel_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE8A4` | `gText_Item_Article_HarvestGoddessJewel_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE8E0` | `gText_Item_Article_KappaJewel_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE8EC` | `gText_Item_Article_KappaJewel_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE92C` | `gText_Item_Article_JewelOfTruth_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE938` | `gText_Item_Article_JewelOfTruth_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE964` | `gText_Item_Article_TheSpringSun_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE970` | `gText_Item_Article_TheSpringSun_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE9A4` | `gText_Item_Article_TheSummerSun_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE9B0` | `gText_Item_Article_TheAutumnSun_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE9BC` | `gText_Item_Article_TheWinterSun_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE9C8` | `gText_Item_Article_Bracelet_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE9D8` | `gText_Item_Article_Bracelet_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEA14` | `gText_Item_Article_Necklace_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEA20` | `gText_Item_Article_Necklace_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEA58` | `gText_Item_Article_Earrings_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEA64` | `gText_Item_Article_Earrings_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEA9C` | `gText_Item_Article_Broach_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEAA8` | `gText_Item_Article_Broach_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEAE0` | `gText_Item_Article_Weeds_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEAE8` | `gText_Item_Article_Weeds_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEB1C` | `gText_Item_Article_Stones_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEB20` | `gText_Item_Article_Stones_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEB58` | `gText_Item_Article_Branches_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEB5C` | `gText_Item_Article_Branches_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEB94` | `gText_Item_Article_Lithograph_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEBA0` | `gText_Item_Article_Lithograph_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEBE8` | `gText_Item_Article_MessageInABottle_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEBF8` | `gText_Item_Article_MessageInABottle_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEC44` | `gText_Item_Article_Ball_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEC4C` | `gText_Item_Article_Ball_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEC6C` | `gText_Item_Article_PirateTreasure_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEC78` | `gText_Item_Article_PirateTreasure_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EECB0` | `gText_Item_Article_FossilOfFish_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EECC0` | `gText_Item_Article_FossilOfFish_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EED00` | `gText_Item_Article_EmptyCan_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EED08` | `gText_Item_Article_EmptyCan_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EED1C` | `gText_Item_Article_Boots_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EED24` | `gText_Item_Article_Boots_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EED34` | `gText_Item_Article_FishBones_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EED3C` | `gText_Item_Article_FishBones_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EED50` | `gText_Item_Article_KarensWine_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EED60` | `gText_Item_Article_KarensWine_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEDAC` | `gText_Item_Article_PopurisMudBall_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEDBC` | `gText_Item_Article_PopurisMudBall_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEE00` | `gText_Item_Article_AnnsMusicBox_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEE14` | `gText_Item_Article_AnnsMusicBox_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEE60` | `gText_Item_Article_MarysGreatBook_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEE74` | `gText_Item_Article_MarysGreatBook_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEEBC` | `gText_Item_Article_EllisPressedFlower_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEECC` | `gText_Item_Article_EllisPressedFlower_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEF14` | `gText_Item_Article_Album1_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEF20` | `gText_Item_Article_Album1_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEF44` | `gText_Item_Article_Album2_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEF50` | `gText_Item_Article_Album2_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEF74` | `gText_Item_Article_Album3_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEF80` | `gText_Item_Article_Album3_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEFA4` | `gText_Item_Article_Album4_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEFB0` | `gText_Item_Article_Album4_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEFD8` | `gText_Item_Article_Album5_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEFE4` | `gText_Item_Article_Album5_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF010` | `gText_Item_Article_Album6_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF01C` | `gText_Item_Article_Album6_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF048` | `gText_Item_Article_Album7_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF054` | `gText_Item_Article_Album7_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF078` | `gText_Item_Article_Album8_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF084` | `gText_Item_Article_Album8_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF0A8` | `gText_Item_Article_Album9_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF0B4` | `gText_Item_Article_Album9_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF0D8` | `gText_Item_Article_Album10_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF0E8` | `gText_Item_Article_Album10_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF10C` | `gText_Item_Article_Album11_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF11C` | `gText_Item_Article_Album11_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF15C` | `gText_Item_Article_Album12_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF16C` | `gText_Item_Article_Album12_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF1AC` | `gText_Item_Article_Album13_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF1BC` | `gText_Item_Article_Album13_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF1FC` | `gText_Item_Article_Album14_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF20C` | `gText_Item_Article_Album14_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF24C` | `gText_Item_Article_Album15_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF25C` | `gText_Item_Article_Album15_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF29C` | `gText_Item_Article_Bandaid_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF2AC` | `gText_Item_Article_Bandaid_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF2F0` | `gText_Item_Article_Book_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF2F4` | `gText_Item_Article_Book_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF348` | `gText_Item_Article_Perfume_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF350` | `gText_Item_Article_Perfume_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF390` | `gText_Item_Article_Photo_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF398` | `gText_Item_Article_Photo_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF3D8` | `gText_Item_Article_PlantEncyclopedia_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF3E4` | `gText_Item_Article_PlantEncyclopedia_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF428` | `gText_Item_Article_Invitation_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF430` | `gText_Item_Article_Invitation_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF46C` | `gText_Item_Article_Dress_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF474` | `gText_Item_Article_Dress_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF4B4` | `gText_Item_Article_FacialPack_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF4C4` | `gText_Item_Article_FacialPack_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF510` | `gText_Item_Article_SkinLotion_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF518` | `gText_Item_Article_SkinLotion_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF558` | `gText_Item_Article_Sunblock_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF564` | `gText_Item_Article_Sunblock_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF5A4` | `gText_Item_Article_Lumber_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF5AC` | `gText_Item_Article_Lumber_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF5F0` | `gText_Item_Article_GoldenLumber_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF5FC` | `gText_Item_Article_GoldenLumber_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF630` | `gText_Item_Article_AnimalFodder_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF638` | `gText_Item_Article_AnimalFodder_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF670` | `gText_Item_Article_ChickenFeed_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF67C` | `gText_Item_Article_ChickenFeed_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF6A4` | `gText_Item_Article_Lottery_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF6AC` | `gText_Item_Article_Lottery_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF6EC` | `gText_Item_Article_Frisbee_Name` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF6F8` | `gText_Item_Article_Frisbee_Description` | `data/text/jp/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFD52` | `gText_Calendar_SeasonNames` | `data/text/jp/game_state.cc` | `src/game_state.o(.rodata)` |
| `0x080EFD60` | `gText_Calendar_None` | `data/text/jp/game_state.cc` | `src/game_state.o(.rodata)` |
| `0x080EFD63` | `gText_Calendar_WeekdayNames` | `data/text/jp/game_state.cc` | `src/game_state.o(.rodata)` |
...
| `0x080EFDC4` | `gCppRuntimeBadAlloc_GameState` | `data/text/jp/game_state_1.cc` | `src/game_state.o(.rodata)` |
...
| `0x080EFEA4` | `gText_AnimalMemorial_LineBreak` | `data/text/jp/animal_data.cc` | `src/animal_data.o(.rodata)` |
| `0x080EFEA8` | `gText_AnimalMemorial_Continue` | `data/text/jp/animal_data.cc` | `src/animal_data.o(.rodata)` |
| `0x080EFEAC` | `gText_AnimalMemorial_PageBreak` | `data/text/jp/animal_data.cc` | `src/animal_data.o(.rodata)` |
| `0x080EFEB0` | `gText_AnimalMemorial_Header` | `data/text/jp/animal_data.cc` | `src/animal_data.o(.rodata)` |
| `0x080EFEB8` | `gText_AnimalMemorial_FarmPrefix` | `data/text/jp/animal_data.cc` | `src/animal_data.o(.rodata)` |
| `0x080EFEC8` | `gText_AnimalMemorial_PassedAway` | `data/text/jp/animal_data.cc` | `src/animal_data.o(.rodata)` |
| `0x080EFEDC` | `gText_AnimalMemorial_NamesIntro` | `data/text/jp/animal_data.cc` | `src/animal_data.o(.rodata)` |
| `0x080EFEF8` | `gText_AnimalMemorial_PrayerIntro` | `data/text/jp/animal_data.cc` | `src/animal_data.o(.rodata)` |
| `0x080EFF0C` | `gText_AnimalMemorial_PrayerEnding` | `data/text/jp/animal_data.cc` | `src/animal_data.o(.rodata)` |
| `0x080EFF28` | `gText_AnimalMemorial_PassedNaturalLife` | `data/text/jp/animal_data.cc` | `src/animal_data.o(.rodata)` |
...
| `0x080F11E0` | `gText_EmptyUiLabel` | `data/text/jp/common_ui.cc` | `src/common_ui.o(.rodata)` |
...
| `0x080FAB0C` | `gText_IntroScene_FatherFishingInvitation` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FAB5C` | `gText_IntroScene_MotherCannotFindPlayer` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FAB94` | `gText_IntroScene_PlayerResponseWhat` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FABA4` | `gText_IntroScene_OldManName` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FABB0` | `gText_IntroScene_OldManFindsPlayer` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FAC58` | `gText_IntroScene_MotherThanksOldMan` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FAC90` | `gText_IntroScene_FatherExplainsVacation` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FACF8` | `gText_IntroScene_OldManOffersStay` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FAD50` | `gText_IntroScene_FatherAsksAboutStay` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FAD6C` | `gText_IntroScene_OldManWelcomesFamily` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FADB4` | `gText_IntroScene_MotherTellsPlayerToPlay` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FADF0` | `gText_IntroScene_UnknownName` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FADF8` | `gText_IntroScene_UnknownCallsPlayer` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FAE14` | `gText_IntroScene_UnknownFindsPlayer` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FAE1C` | `gText_IntroScene_GirlName` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FAE24` | `gText_IntroScene_GirlThinksPlayerDead` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FAE58` | `gText_IntroScene_GirlInvitesPlayerToPlay` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FAEAC` | `gText_IntroScene_GirlAsksPlayerStory` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FAF28` | `gText_IntroScene_OldManFarewell` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FAFBC` | `gText_IntroScene_OldManRequestsLetter` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FAFF4` | `gText_IntroScene_OldManGivesAddress` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB034` | `gText_IntroScene_GirlSaysGoodbye` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB054` | `gText_IntroScene_GirlAsksPlayerToReturn` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB0B0` | `gText_IntroScene_OldManNotesFriend` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB0F4` | `gText_IntroScene_OldManWaitsForLetter` | `data/text/jp/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
...
| `0x080FE3A0` | `gText_BeachCafeShop_WaterDescription` | `data/text/jp/beach_cafe_shop_data.cc` | `src/beach_cafe_shop_data.o(.rodata)` |
| `0x080FE3C0` | `gText_BeachCafeShop_EmptyDescription` | `data/text/jp/beach_cafe_shop_data.cc` | `src/beach_cafe_shop_data.o(.rodata)` |
| `0x080FE3C4` | `gText_BeachCafeShop_SpaghettiDescription` | `data/text/jp/beach_cafe_shop_data.cc` | `src/beach_cafe_shop_data.o(.rodata)` |
| `0x080FE3E8` | `gText_BeachCafeShop_SnowConeDescription` | `data/text/jp/beach_cafe_shop_data.cc` | `src/beach_cafe_shop_data.o(.rodata)` |
| `0x080FE4A0` | `gText_BeachCafeShop_InsufficientGold` | `data/text/jp/beach_cafe_shop_data_1.cc` | `src/beach_cafe_shop_data.o(.rodata)` |
| `0x080FE4B8` | `gText_BeachCafeShop_NoOrder` | `data/text/jp/beach_cafe_shop_data_1.cc` | `src/beach_cafe_shop_data.o(.rodata)` |
| `0x080FE4F4` | `gText_BeachCafeShop_OrderComplete` | `data/text/jp/beach_cafe_shop_data_1.cc` | `src/beach_cafe_shop_data.o(.rodata)` |
...
| `0x081032EC` | `gText_FishingRecord_MessageBottle` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081032FC` | `gText_FishingRecord_EmptyCan` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103304` | `gText_FishingRecord_Branch` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103308` | `gText_FishingRecord_FishBones` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103310` | `gText_FishingRecord_Boots` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103318` | `gText_FishingRecord_RockTrout` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103324` | `gText_FishingRecord_Scad` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x0810332C` | `gText_FishingRecord_Fatminnow` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103338` | `gText_FishingRecord_CherrySalmon` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103340` | `gText_FishingRecord_Pigfish` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103348` | `gText_FishingRecord_Sardine` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103350` | `gText_FishingRecord_MountainTrout` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103358` | `gText_FishingRecord_Whitefish` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103360` | `gText_FishingRecord_Eel` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103368` | `gText_FishingRecord_Bitterling` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103374` | `gText_FishingRecord_Bonito` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x0810337C` | `gText_FishingRecord_Fluke` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103384` | `gText_FishingRecord_Filefish` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103390` | `gText_FishingRecord_GoldenCarp` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x0810339C` | `gText_FishingRecord_SilverCarp22` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081033A8` | `gText_FishingRecord_KelpBass` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081033B0` | `gText_FishingRecord_Bighead` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081033BC` | `gText_FishingRecord_Salmon` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081033C4` | `gText_FishingRecord_Mackerel` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081033CC` | `gText_FishingRecord_Needlefish` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081033D4` | `gText_FishingRecord_SpanishMackerel` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081033DC` | `gText_FishingRecord_SauryPike` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081033E4` | `gText_FishingRecord_Dorado` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081033EC` | `gText_FishingRecord_RedSnapper` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081033F4` | `gText_FishingRecord_Cod` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081033FC` | `gText_FishingRecord_Roach` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103408` | `gText_FishingRecord_BrownHakeling` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103410` | `gText_FishingRecord_RainbowTrout` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x0810341C` | `gText_FishingRecord_Herring` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103424` | `gText_FishingRecord_SilverCarp37` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103430` | `gText_FishingRecord_Sandfish` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x0810343C` | `gText_FishingRecord_Flounder` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103444` | `gText_FishingRecord_Blowfish` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x0810344C` | `gText_FishingRecord_BlackBass` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x0810345C` | `gText_FishingRecord_Yellowtail` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103464` | `gText_FishingRecord_Bluegill` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103470` | `gText_FishingRecord_CrucianCarp` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x0810347C` | `gText_FishingRecord_Greenling` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103484` | `gText_FishingRecord_Tuna` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x0810348C` | `gText_FishingRecord_OceanSunfish` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103498` | `gText_FishingRecord_Lionfish` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081034A4` | `gText_FishingRecord_Rockfish` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081034AC` | `gText_FishingRecord_LargeSalmon` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081034B4` | `gText_FishingRecord_Snakehead` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081034C0` | `gText_FishingRecord_LakeSmelt` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081034CC` | `gText_FishingRecord_JapaneseHuchen` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081034D4` | `gText_FishingRecord_Monkfish` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081034E0` | `gText_FishingRecord_Catfish` | `data/text/jp/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
...
| `0x080F04EE`–`0x080F0509` | `src/game_state.o(.rodata)` | [嵌入文本 / 数据] | `src/game_state.cc`<br>`include/game_state.hh`<br>`data/text/us/game_state.cc` | 固定季节行文本 `1` 项（保留必要的二字节起始对齐） |
| `0x080F050A`–`0x080F050B` | `*fill*` | [填充] | 链接脚本填充字节 `00` | 2 字节 |
| `0x080F050C`–`0x080F0589` | `src/game_state.o(.rodata)` | [嵌入文本 / 数据] | `src/game_state.cc`<br>`include/game_state.hh`<br>`data/text/us/game_state.cc`<br>`data/text/us/game_state_1.cc` | 文本 `3` 项（详见下方索引）<br>运行时字符串 `5` 项<br>`gUnk_080F0566`（普通数据）<br>尾部运行时文本 `1` 项 |
...
| `0x080F1974`–`0x080F1A7D` | `src/common_ui.o(.rodata)` | [嵌入文本 / 数据] | `src/common_ui.cc`<br>`include/common_ui.hh`<br>`data/text/us/common_ui.cc`–`common_ui_6.cc` | 文本 `12` 项（详见下方索引）<br>运行时字符串 `6` 项<br>`gText_EmptyUiLabel`、`gUnk_080F19AE`、`gMenuEntryIds`、`gMenuEntryLabels`、`gUnk_080F1A66`<br>固定容量文本槽保留原始字节；所有汇编读取均为直接符号重定位；下方起点约束此可本地化范围 |
...
| `0x080F33B8`–`0x080F89D3` | `src/entity_ui_resource_selector.o(.rodata)` | [嵌入文本 / 数据] | `src/entity_ui_resource_selector.cc`<br>`include/entity_ui_resource_selector.hh`<br>`data/text/us/entity_ui_resource_selector.cc`–`entity_ui_resource_selector_23.cc` | 运行时字符串 `24` 项<br>25 个连续选择器描述符（由 `gUnk_080F33B8` 至 `gUnk_080F8678` 的物理顺序组成）<br>顶层描述符、表、条目、载荷、详情记录与运行时文本均由同名头文件声明；内部和外部调用均为符号重定位 |
...
| `0x080FE050`–`0x080FE261` | `src/clinic_data.o(.rodata)` | [嵌入文本 / 数据] | `src/clinic_data.cc`<br>`include/clinic_data.hh`<br>`data/text/us/clinic_data.cc` | `gClinicCatalog`<br>文本 `9` 项（详见下方索引）<br>运行时字符串 `1` 项 |
...
| `0x080FEAF4`–`0x080FEC79` | `src/beach_cafe_shop_data.o(.rodata)` | [嵌入文本 / 数据] | `src/beach_cafe_shop_data.cc`<br>`include/beach_cafe_shop_data.hh`<br>`data/text/us/beach_cafe_shop_data.cc`<br>`data/text/us/beach_cafe_shop_data_1.cc` | 说明文本 `4` 项<br>`gBeachCafeShopMenu`<br>对话文本 `3` 项<br>运行时字符串 `1` 项 |
...
| `0x080E96C0` | `gText_Item_Tool_CopperSickle_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9704` | `gText_Item_Tool_SilverSickle_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9714` | `gText_Item_Tool_SilverSickle_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9758` | `gText_Item_Tool_GoldSickle_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9764` | `gText_Item_Tool_GoldSickle_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E97A4` | `gText_Item_Tool_MystrileSickle_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E97B4` | `gText_Item_Tool_MystrileSickle_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E97F8` | `gText_Item_Tool_CursedSickle_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9808` | `gText_Item_Tool_CursedSickle_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9844` | `gText_Item_Tool_BlessedSickle_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9854` | `gText_Item_Tool_BlessedSickle_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E988C` | `gText_Item_Tool_MythicSickle_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E989C` | `gText_Item_Tool_MythicSickle_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E98E0` | `gText_Item_Tool_IronHoe_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E98EC` | `gText_Item_Tool_IronHoe_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9928` | `gText_Item_Tool_CopperHoe_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9934` | `gText_Item_Tool_CopperHoe_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9978` | `gText_Item_Tool_SilverHoe_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9984` | `gText_Item_Tool_SilverHoe_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E99C8` | `gText_Item_Tool_GoldHoe_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E99D4` | `gText_Item_Tool_GoldHoe_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9A14` | `gText_Item_Tool_MystrileHoe_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9A24` | `gText_Item_Tool_MystrileHoe_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9A64` | `gText_Item_Tool_CursedHoe_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9A70` | `gText_Item_Tool_CursedHoe_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9AA8` | `gText_Item_Tool_BlessedHoe_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9AB4` | `gText_Item_Tool_BlessedHoe_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9AE8` | `gText_Item_Tool_MythicHoe_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9AF4` | `gText_Item_Tool_MythicHoe_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9B30` | `gText_Item_Tool_IronAxe_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9B3C` | `gText_Item_Tool_IronAxe_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9B78` | `gText_Item_Tool_CopperAxe_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9B84` | `gText_Item_Tool_CopperAxe_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9BB8` | `gText_Item_Tool_SilverAxe_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9BC4` | `gText_Item_Tool_SilverAxe_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9BF8` | `gText_Item_Tool_GoldAxe_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9C04` | `gText_Item_Tool_GoldAxe_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9C38` | `gText_Item_Tool_MystrileAxe_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9C48` | `gText_Item_Tool_MystrileAxe_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9C80` | `gText_Item_Tool_CursedAxe_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9C8C` | `gText_Item_Tool_CursedAxe_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9CC0` | `gText_Item_Tool_BlessedAxe_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9CCC` | `gText_Item_Tool_BlessedAxe_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9D00` | `gText_Item_Tool_MythicAxe_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9D0C` | `gText_Item_Tool_MythicAxe_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9D40` | `gText_Item_Tool_IronHammer_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9D4C` | `gText_Item_Tool_IronHammer_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9D8C` | `gText_Item_Tool_CopperHammer_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9D9C` | `gText_Item_Tool_CopperHammer_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9DE8` | `gText_Item_Tool_SilverHammer_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9DF8` | `gText_Item_Tool_SilverHammer_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9E34` | `gText_Item_Tool_GoldHammer_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9E40` | `gText_Item_Tool_GoldHammer_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9E84` | `gText_Item_Tool_MystrileHammer_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9E94` | `gText_Item_Tool_MystrileHammer_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9EDC` | `gText_Item_Tool_CursedHammer_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9EEC` | `gText_Item_Tool_CursedHammer_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9F28` | `gText_Item_Tool_BlessedHammer_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9F38` | `gText_Item_Tool_BlessedHammer_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9F74` | `gText_Item_Tool_MythicHammer_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9F84` | `gText_Item_Tool_MythicHammer_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9FCC` | `gText_Item_Tool_WateringCan_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9FDC` | `gText_Item_Tool_WateringCan_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080E9FFC` | `gText_Item_Tool_CopperWateringCan_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA010` | `gText_Item_Tool_CopperWateringCan_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA034` | `gText_Item_Tool_SilverWateringCan_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA048` | `gText_Item_Tool_SilverWateringCan_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA06C` | `gText_Item_Tool_GoldWateringCan_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA080` | `gText_Item_Tool_GoldWateringCan_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA0A4` | `gText_Item_Tool_MystrileWateringCan_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA0BC` | `gText_Item_Tool_MystrileWateringCan_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA0E4` | `gText_Item_Tool_CursedWateringCan_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA0F8` | `gText_Item_Tool_CursedWateringCan_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA138` | `gText_Item_Tool_BlessedWateringCan_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA150` | `gText_Item_Tool_BlessedWateringCan_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA180` | `gText_Item_Tool_MythicWateringCan_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA194` | `gText_Item_Tool_MythicWateringCan_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA1B8` | `gText_Item_Tool_FishingRod_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA1C4` | `gText_Item_Tool_FishingRod_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA1DC` | `gText_Item_Tool_CopperFishingRod_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA1F0` | `gText_Item_Tool_CopperFishingRod_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA214` | `gText_Item_Tool_SilverFishingRod_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA228` | `gText_Item_Tool_SilverFishingRod_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA24C` | `gText_Item_Tool_GoldFishingRod_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA260` | `gText_Item_Tool_GoldFishingRod_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA284` | `gText_Item_Tool_MystrileFishingRod_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA29C` | `gText_Item_Tool_MystrileFishingRod_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA2C4` | `gText_Item_Tool_CursedFishingRod_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA2D8` | `gText_Item_Tool_CursedFishingRod_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA318` | `gText_Item_Tool_BlessedFishingRod_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA32C` | `gText_Item_Tool_BlessedFishingRod_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA370` | `gText_Item_Tool_MythicFishingRod_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA384` | `gText_Item_Tool_MythicFishingRod_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA3A8` | `gText_Item_Tool_CowMiraclePotion_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA3BC` | `gText_Item_Tool_CowMiraclePotion_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA3F0` | `gText_Item_Tool_SheepMiraclePotion_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA408` | `gText_Item_Tool_SheepMiraclePotion_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA440` | `gText_Item_Tool_TurnipSeeds_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA450` | `gText_Item_Tool_TurnipSeeds_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA474` | `gText_Item_Tool_PotatoSeeds_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA484` | `gText_Item_Tool_PotatoSeeds_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA4A8` | `gText_Item_Tool_CucumberSeeds_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA4B8` | `gText_Item_Tool_CucumberSeeds_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA4DC` | `gText_Item_Tool_StrawberrySeeds_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA4F0` | `gText_Item_Tool_StrawberrySeeds_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA518` | `gText_Item_Tool_CabbageSeeds_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA528` | `gText_Item_Tool_CabbageSeeds_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA54C` | `gText_Item_Tool_TomatoSeeds_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA55C` | `gText_Item_Tool_TomatoSeeds_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA580` | `gText_Item_Tool_CornSeeds_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA58C` | `gText_Item_Tool_CornSeeds_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA5AC` | `gText_Item_Tool_OnionSeeds_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA5B8` | `gText_Item_Tool_OnionSeeds_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA5D8` | `gText_Item_Tool_PumpkinSeeds_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA5E8` | `gText_Item_Tool_PumpkinSeeds_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA60C` | `gText_Item_Tool_PineappleSeeds_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA61C` | `gText_Item_Tool_PineappleSeeds_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA640` | `gText_Item_Tool_EggplantSeeds_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA650` | `gText_Item_Tool_EggplantSeeds_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA674` | `gText_Item_Tool_CarrotSeeds_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA684` | `gText_Item_Tool_CarrotSeeds_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA6A4` | `gText_Item_Tool_SweetPotatoSeeds_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA6B8` | `gText_Item_Tool_SweetPotatoSeeds_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA6E0` | `gText_Item_Tool_SpinachSeeds_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA6F0` | `gText_Item_Tool_SpinachSeeds_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA710` | `gText_Item_Tool_GreenPepperSeeds_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA724` | `gText_Item_Tool_GreenPepperSeeds_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA74C` | `gText_Item_Tool_GrassSeeds_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA758` | `gText_Item_Tool_GrassSeeds_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA784` | `gText_Item_Tool_MoonDropSeeds_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA794` | `gText_Item_Tool_MoonDropSeeds_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA7C0` | `gText_Item_Tool_PinkCatSeeds_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA7D0` | `gText_Item_Tool_PinkCatSeeds_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA7FC` | `gText_Item_Tool_MagicSeeds_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA808` | `gText_Item_Tool_MagicSeeds_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA828` | `gText_Item_Tool_ToyFlowerSeeds_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA83C` | `gText_Item_Tool_ToyFlowerSeeds_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA864` | `gText_Item_Tool_Brush_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA86C` | `gText_Item_Tool_Brush_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA8A4` | `gText_Item_Tool_Milker_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA8AC` | `gText_Item_Tool_Milker_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA8DC` | `gText_Item_Tool_Clipper_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA8E4` | `gText_Item_Tool_Clipper_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA914` | `gText_Item_Tool_Bell_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA91C` | `gText_Item_Tool_Bell_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA950` | `gText_Item_Tool_AnimalMedicine_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA960` | `gText_Item_Tool_AnimalMedicine_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA990` | `gText_Item_Tool_BlueFeather_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA9A0` | `gText_Item_Tool_BlueFeather_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA9D8` | `gText_Item_Tool_Pedometer_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA9E4` | `gText_Item_Tool_Pedometer_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EA9F0` | `gText_Item_Tool_TeleportStone_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EAA00` | `gText_Item_Tool_TeleportStone_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EAA38` | `gText_Item_Tool_GemOfTheGoddess_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EAA4C` | `gText_Item_Tool_GemOfTheGoddess_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EAA80` | `gText_Item_Tool_GemOfTheKappa_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EAA94` | `gText_Item_Tool_GemOfTheKappa_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EAAC8` | `gText_Item_Tool_GemOfTruth_Name` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EAAD8` | `gText_Item_Tool_GemOfTruth_Description` | `data/text/us/item.cc` | `src/item.o(.rodata)` |
| `0x080EAED8` | `gText_Item_Food_Turnip_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAEE0` | `gText_Item_Food_Turnip_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAF04` | `gText_Item_Food_Potato_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAF0C` | `gText_Item_Food_Potato_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAF30` | `gText_Item_Food_Cucumber_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAF3C` | `gText_Item_Food_Cucumber_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAF64` | `gText_Item_Food_Strawberry_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAF70` | `gText_Item_Food_Strawberry_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAF98` | `gText_Item_Food_Cabbage_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAFA0` | `gText_Item_Food_Cabbage_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAFC4` | `gText_Item_Food_Tomato_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAFCC` | `gText_Item_Food_Tomato_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAFF0` | `gText_Item_Food_Corn_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EAFF8` | `gText_Item_Food_Corn_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB01C` | `gText_Item_Food_Onion_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB024` | `gText_Item_Food_Onion_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB048` | `gText_Item_Food_Pumpkin_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB050` | `gText_Item_Food_Pumpkin_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB074` | `gText_Item_Food_Pineapple_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB080` | `gText_Item_Food_Pineapple_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB0A8` | `gText_Item_Food_Eggplant_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB0B4` | `gText_Item_Food_Eggplant_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB0DC` | `gText_Item_Food_Carrot_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB0E4` | `gText_Item_Food_Carrot_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB108` | `gText_Item_Food_SweetPotato_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB118` | `gText_Item_Food_SweetPotato_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB144` | `gText_Item_Food_Spinach_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB14C` | `gText_Item_Food_Spinach_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB170` | `gText_Item_Food_GreenPepper_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB180` | `gText_Item_Food_GreenPepper_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB1AC` | `gText_Item_Food_RegularQualityEgg_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB1C0` | `gText_Item_Food_RegularQualityEgg_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB1F0` | `gText_Item_Food_GoodQualityEgg_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB204` | `gText_Item_Food_GoodQualityEgg_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB234` | `gText_Item_Food_HighQualityEgg_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB248` | `gText_Item_Food_HighQualityEgg_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB278` | `gText_Item_Food_GoldenEgg_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB284` | `gText_Item_Food_GoldenEgg_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB2AC` | `gText_Item_Food_PEgg_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB2B4` | `gText_Item_Food_PEgg_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB2D8` | `gText_Item_Food_XEgg_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB2E0` | `gText_Item_Food_XEgg_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB304` | `gText_Item_Food_SpaboiledEgg_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB314` | `gText_Item_Food_SpaboiledEgg_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB358` | `gText_Item_Food_MayonnaiseS_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB368` | `gText_Item_Food_MayonnaiseS_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB3A0` | `gText_Item_Food_MayonnaiseM_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB3B0` | `gText_Item_Food_MayonnaiseM_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB3E8` | `gText_Item_Food_MayonnaiseL_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB3F8` | `gText_Item_Food_MayonnaiseL_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB430` | `gText_Item_Food_MayonnaiseG_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB440` | `gText_Item_Food_MayonnaiseG_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB478` | `gText_Item_Food_MayonnaiseP_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB488` | `gText_Item_Food_MayonnaiseP_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB4C0` | `gText_Item_Food_MayonnaiseX_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB4D0` | `gText_Item_Food_MayonnaiseX_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB508` | `gText_Item_Food_MilkS_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB514` | `gText_Item_Food_MilkS_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB54C` | `gText_Item_Food_MilkM_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB558` | `gText_Item_Food_MilkM_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB590` | `gText_Item_Food_MilkL_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB59C` | `gText_Item_Food_MilkL_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB5D4` | `gText_Item_Food_MilkG_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB5E0` | `gText_Item_Food_MilkG_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB618` | `gText_Item_Food_MilkP_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB624` | `gText_Item_Food_MilkP_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB65C` | `gText_Item_Food_MilkX_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB668` | `gText_Item_Food_MilkX_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB6A0` | `gText_Item_Food_CheeseS_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB6AC` | `gText_Item_Food_CheeseS_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB6DC` | `gText_Item_Food_CheeseM_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB6E8` | `gText_Item_Food_CheeseM_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB718` | `gText_Item_Food_CheeseL_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB724` | `gText_Item_Food_CheeseL_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB754` | `gText_Item_Food_CheeseG_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB760` | `gText_Item_Food_CheeseG_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB790` | `gText_Item_Food_CheeseP_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB79C` | `gText_Item_Food_CheeseP_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB7CC` | `gText_Item_Food_CheeseX_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB7D8` | `gText_Item_Food_CheeseX_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB808` | `gText_Item_Food_Apple_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB810` | `gText_Item_Food_Apple_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB848` | `gText_Item_Food_Honey_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB850` | `gText_Item_Food_Honey_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB888` | `gText_Item_Food_BambooShoot_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB898` | `gText_Item_Food_BambooShoot_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB8DC` | `gText_Item_Food_WildGrapes_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB8E8` | `gText_Item_Food_WildGrapes_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB92C` | `gText_Item_Food_Mushroom_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB938` | `gText_Item_Food_Mushroom_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB978` | `gText_Item_Food_PoisonousMushroom_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB98C` | `gText_Item_Food_PoisonousMushroom_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB9D4` | `gText_Item_Food_Truffle_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EB9DC` | `gText_Item_Food_Truffle_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBA10` | `gText_Item_Food_BlueGrass_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBA1C` | `gText_Item_Food_BlueGrass_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBA64` | `gText_Item_Food_GreenGrass_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBA70` | `gText_Item_Food_GreenGrass_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBAB8` | `gText_Item_Food_RedGrass_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBAC4` | `gText_Item_Food_RedGrass_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBB00` | `gText_Item_Food_YellowGrass_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBB10` | `gText_Item_Food_YellowGrass_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBB50` | `gText_Item_Food_OrangeGrass_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBB60` | `gText_Item_Food_OrangeGrass_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBB94` | `gText_Item_Food_PurpleGrass_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBBA4` | `gText_Item_Food_PurpleGrass_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBBDC` | `gText_Item_Food_IndigoGrass_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBBEC` | `gText_Item_Food_IndigoGrass_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBC2C` | `gText_Item_Food_BlackGrass_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBC38` | `gText_Item_Food_BlackGrass_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBC70` | `gText_Item_Food_WhiteGrass_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBC7C` | `gText_Item_Food_WhiteGrass_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBCB4` | `gText_Item_Food_QueenOfTheNight_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBCC8` | `gText_Item_Food_QueenOfTheNight_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBD0C` | `gText_Item_Food_Bodigizer_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBD18` | `gText_Item_Food_Bodigizer_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBD40` | `gText_Item_Food_BodigizerXl_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBD50` | `gText_Item_Food_BodigizerXl_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBD84` | `gText_Item_Food_Turbojolt_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBD90` | `gText_Item_Food_Turbojolt_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBDB8` | `gText_Item_Food_TurbojoltXl_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBDC8` | `gText_Item_Food_TurbojoltXl_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBDFC` | `gText_Item_Food_Wine_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBE04` | `gText_Item_Food_Wine_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBE40` | `gText_Item_Food_GrapeJuice_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBE4C` | `gText_Item_Food_GrapeJuice_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBE90` | `gText_Item_Food_RiceBall_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBE9C` | `gText_Item_Food_RiceBall_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBED4` | `gText_Item_Food_Bread_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBEDC` | `gText_Item_Food_Bread_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBF10` | `gText_Item_Food_Oil_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBF14` | `gText_Item_Food_Oil_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBF44` | `gText_Item_Food_Flower_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBF4C` | `gText_Item_Food_Flower_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBF80` | `gText_Item_Food_CurryPowder_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBF90` | `gText_Item_Food_CurryPowder_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBFC8` | `gText_Item_Food_MuffinMix_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EBFD4` | `gText_Item_Food_MuffinMix_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC00C` | `gText_Item_Food_Chocolate_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC018` | `gText_Item_Food_Chocolate_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC050` | `gText_Item_Food_RelaxTeaLeaves_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC064` | `gText_Item_Food_RelaxTeaLeaves_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC0AC` | `gText_Item_Food_SugdwApple_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC0B8` | `gText_Item_Food_SugdwApple_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC100` | `gText_Item_Food_HmsgbApple_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC10C` | `gText_Item_Food_HmsgbApple_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC150` | `gText_Item_Food_AepfeApple_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC15C` | `gText_Item_Food_AepfeApple_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC19C` | `gText_Item_Food_BuckwheatFlour_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC1AC` | `gText_Item_Food_BuckwheatFlour_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC1E8` | `gText_Item_Food_WildGrapeJuice_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC1FC` | `gText_Item_Food_WildGrapeJuice_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC220` | `gText_Item_Food_Salad_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC228` | `gText_Item_Food_Salad_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC268` | `gText_Item_Food_CurryRice_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC274` | `gText_Item_Food_CurryRice_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC2B4` | `gText_Item_Food_Stew_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC2BC` | `gText_Item_Food_Stew_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC2F0` | `gText_Item_Food_MisoSoup_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC2FC` | `gText_Item_Food_MisoSoup_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC338` | `gText_Item_Food_StirFry_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC344` | `gText_Item_Food_StirFry_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC380` | `gText_Item_Food_FriedRice_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC38C` | `gText_Item_Food_FriedRice_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC3C8` | `gText_Item_Food_SavoryPancake_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC3D8` | `gText_Item_Food_SavoryPancake_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC420` | `gText_Item_Food_Sandwich_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC42C` | `gText_Item_Food_Sandwich_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC464` | `gText_Item_Food_FruitJuice_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC470` | `gText_Item_Food_FruitJuice_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC4B4` | `gText_Item_Food_VegetableJuice_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC4C4` | `gText_Item_Food_VegetableJuice_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC50C` | `gText_Item_Food_MixedJuice_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC518` | `gText_Item_Food_MixedJuice_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC55C` | `gText_Item_Food_FruitLatte_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC568` | `gText_Item_Food_FruitLatte_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC5AC` | `gText_Item_Food_VegetableLatte_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC5BC` | `gText_Item_Food_VegetableLatte_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC5F8` | `gText_Item_Food_MixedLatte_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC604` | `gText_Item_Food_MixedLatte_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC644` | `gText_Item_Food_StrawberryMilk_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC654` | `gText_Item_Food_StrawberryMilk_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC69C` | `gText_Item_Food_StrawberryJam_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC6AC` | `gText_Item_Food_StrawberryJam_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC6F4` | `gText_Item_Food_TomatoJuice_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC704` | `gText_Item_Food_TomatoJuice_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC74C` | `gText_Item_Food_PickledTurnip_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC75C` | `gText_Item_Food_PickledTurnip_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC798` | `gText_Item_Food_FrenchFries_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC7A8` | `gText_Item_Food_FrenchFries_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC7E8` | `gText_Item_Food_Pickles_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC7F0` | `gText_Item_Food_Pickles_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC828` | `gText_Item_Food_Ketchup_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC830` | `gText_Item_Food_Ketchup_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC870` | `gText_Item_Food_Popcorn_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC878` | `gText_Item_Food_Popcorn_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC8B4` | `gText_Item_Food_CornFlakes_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC8C0` | `gText_Item_Food_CornFlakes_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC900` | `gText_Item_Food_BakedCorn_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC90C` | `gText_Item_Food_BakedCorn_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC948` | `gText_Item_Food_PineappleJuice_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC958` | `gText_Item_Food_PineappleJuice_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC9A0` | `gText_Item_Food_PumpkinPudding_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC9B0` | `gText_Item_Food_PumpkinPudding_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EC9F0` | `gText_Item_Food_PumpkinStew_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECA00` | `gText_Item_Food_PumpkinStew_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECA40` | `gText_Item_Food_HappyEggplant_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECA50` | `gText_Item_Food_HappyEggplant_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECA94` | `gText_Item_Food_SweetPotatoes_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECAA4` | `gText_Item_Food_SweetPotatoes_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECAE0` | `gText_Item_Food_BakedSweetPotato_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECAF4` | `gText_Item_Food_BakedSweetPotato_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECB38` | `gText_Item_Food_Greens_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECB40` | `gText_Item_Food_Greens_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECB7C` | `gText_Item_Food_ScrambledEggs_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECB8C` | `gText_Item_Food_ScrambledEggs_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECBCC` | `gText_Item_Food_Omelet_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECBD4` | `gText_Item_Food_Omelet_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECC0C` | `gText_Item_Food_OmeletRice_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECC18` | `gText_Item_Food_OmeletRice_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECC58` | `gText_Item_Food_BoiledEgg_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECC64` | `gText_Item_Food_BoiledEgg_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECCA4` | `gText_Item_Food_HotMilk_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECCB0` | `gText_Item_Food_HotMilk_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECCEC` | `gText_Item_Food_Butter_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECCF4` | `gText_Item_Food_Butter_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECD2C` | `gText_Item_Food_CheeseCake_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECD38` | `gText_Item_Food_CheeseCake_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECD78` | `gText_Item_Food_CheeseFondue_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECD88` | `gText_Item_Food_CheeseFondue_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECDCC` | `gText_Item_Food_ApplePie_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECDD8` | `gText_Item_Food_ApplePie_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECE14` | `gText_Item_Food_AppleJam_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECE20` | `gText_Item_Food_AppleJam_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECE60` | `gText_Item_Food_AppleSouffl_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECE70` | `gText_Item_Food_AppleSouffl_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECEB4` | `gText_Item_Food_MushroomRice_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECEC4` | `gText_Item_Food_MushroomRice_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECF04` | `gText_Item_Food_BambooRice_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECF10` | `gText_Item_Food_BambooRice_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECF54` | `gText_Item_Food_TruffleRice_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECF64` | `gText_Item_Food_TruffleRice_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECFA0` | `gText_Item_Food_Sushi_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECFA8` | `gText_Item_Food_Sushi_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECFD8` | `gText_Item_Food_JamBun_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ECFE0` | `gText_Item_Food_JamBun_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED01C` | `gText_Item_Food_DinnerRole_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED028` | `gText_Item_Food_DinnerRole_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED06C` | `gText_Item_Food_RaisinBread_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED07C` | `gText_Item_Food_RaisinBread_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED0BC` | `gText_Item_Food_GrapeJam_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED0C8` | `gText_Item_Food_GrapeJam_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED104` | `gText_Item_Food_CurryBread_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED110` | `gText_Item_Food_CurryBread_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED154` | `gText_Item_Food_Sashimi_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED15C` | `gText_Item_Food_Sashimi_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED198` | `gText_Item_Food_GrilledFish_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED1A8` | `gText_Item_Food_GrilledFish_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED1E8` | `gText_Item_Food_ChirashiSushi_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED1F8` | `gText_Item_Food_ChirashiSushi_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED240` | `gText_Item_Food_Pizza_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED248` | `gText_Item_Food_Pizza_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED280` | `gText_Item_Food_Noodles_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED288` | `gText_Item_Food_Noodles_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED2BC` | `gText_Item_Food_CurryNoodles_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED2CC` | `gText_Item_Food_CurryNoodles_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED314` | `gText_Item_Food_TempuraNoodles_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED324` | `gText_Item_Food_TempuraNoodles_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED364` | `gText_Item_Food_FriedNoodles_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED374` | `gText_Item_Food_FriedNoodles_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED3B0` | `gText_Item_Food_BuckwheatNoodles_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED3C4` | `gText_Item_Food_BuckwheatNoodles_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED400` | `gText_Item_Food_NoodlesWTempura_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED414` | `gText_Item_Food_NoodlesWTempura_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED45C` | `gText_Item_Food_BuckwheatChips_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED46C` | `gText_Item_Food_BuckwheatChips_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED4B4` | `gText_Item_Food_Cookies_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED4BC` | `gText_Item_Food_Cookies_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED4F4` | `gText_Item_Food_ChocolateCookies_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED508` | `gText_Item_Food_ChocolateCookies_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED548` | `gText_Item_Food_Tempura_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED550` | `gText_Item_Food_Tempura_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED580` | `gText_Item_Food_IceCream_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED58C` | `gText_Item_Food_IceCream_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED5C4` | `gText_Item_Food_Cake_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED5CC` | `gText_Item_Food_Cake_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED5FC` | `gText_Item_Food_ChocolateCake_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED60C` | `gText_Item_Food_ChocolateCake_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED64C` | `gText_Item_Food_RelaxationTea_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED65C` | `gText_Item_Food_RelaxationTea_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED69C` | `gText_Item_Food_Toast_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED6A4` | `gText_Item_Food_Toast_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED6D4` | `gText_Item_Food_FrenchToast_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED6E4` | `gText_Item_Food_FrenchToast_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED724` | `gText_Item_Food_Pudding_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED72C` | `gText_Item_Food_Pudding_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED764` | `gText_Item_Food_MountainStew_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED774` | `gText_Item_Food_MountainStew_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED7B4` | `gText_Item_Food_MoonDumplings_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED7C4` | `gText_Item_Food_MoonDumplings_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED80C` | `gText_Item_Food_RiceCake_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED818` | `gText_Item_Food_RiceCake_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED858` | `gText_Item_Food_RoastedRiceCake_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED86C` | `gText_Item_Food_RoastedRiceCake_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED8B0` | `gText_Item_Food_ElliLeaves_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED8BC` | `gText_Item_Food_ElliLeaves_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED900` | `gText_Item_Food_FailedDish_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED90C` | `gText_Item_Food_FailedDish_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED93C` | `gText_Item_Food_FailedDrink_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED94C` | `gText_Item_Food_FailedPotDish_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED95C` | `gText_Item_Food_FailedDessert_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED96C` | `gText_Item_Food_FailedBread_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED97C` | `gText_Item_Food_FailedNoodles_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED98C` | `gText_Item_Food_SmallFish_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED998` | `gText_Item_Food_SmallFish_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED9D8` | `gText_Item_Food_MediumFish_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080ED9E4` | `gText_Item_Food_MediumFish_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EDA28` | `gText_Item_Food_LargeFish_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EDA34` | `gText_Item_Food_LargeFish_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EDA74` | `gText_Item_Food_ToastedRiceBall_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EDA88` | `gText_Item_Food_ToastedRiceBall_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EDAC8` | `gText_Item_Food_TempuraRice_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EDAD8` | `gText_Item_Food_TempuraRice_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EDB14` | `gText_Item_Food_EggOverRice_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EDB24` | `gText_Item_Food_EggOverRice_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EDB68` | `gText_Item_Food_RiceGruel_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EDB74` | `gText_Item_Food_RiceGruel_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EDBAC` | `gText_Item_Food_Pancakes_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EDBB8` | `gText_Item_Food_Pancakes_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EDBF0` | `gText_Item_Food_FishSticks_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EDBFC` | `gText_Item_Food_FishSticks_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EDC34` | `gText_Item_Food_CandiedPotato_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EDC44` | `gText_Item_Food_CandiedPotato_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EDC88` | `gText_Item_Food_PotatoPancakes_Name` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EDC98` | `gText_Item_Food_PotatoPancakes_Description` | `data/text/us/item_1.cc` | `src/item.o(.rodata)` |
| `0x080EE788` | `gText_Item_Article_MoonDropGrass_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE798` | `gText_Item_Article_MoonDropGrass_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE7D0` | `gText_Item_Article_PinkCatGrass_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE7E0` | `gText_Item_Article_PinkCatGrass_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE818` | `gText_Item_Article_BlueMagicGrass_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE82C` | `gText_Item_Article_BlueMagicGrass_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE864` | `gText_Item_Article_RedMagicGrass_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE874` | `gText_Item_Article_RedMagicGrass_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE8AC` | `gText_Item_Article_ToyFlower_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE8B8` | `gText_Item_Article_ToyFlower_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE8EC` | `gText_Item_Article_WoolS_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE8F8` | `gText_Item_Article_WoolS_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE918` | `gText_Item_Article_WoolM_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE924` | `gText_Item_Article_WoolM_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE944` | `gText_Item_Article_WoolL_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE950` | `gText_Item_Article_WoolL_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE970` | `gText_Item_Article_WoolG_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE97C` | `gText_Item_Article_WoolG_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE99C` | `gText_Item_Article_WoolP_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE9A8` | `gText_Item_Article_WoolP_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE9C8` | `gText_Item_Article_YarnS_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EE9D4` | `gText_Item_Article_YarnS_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEA08` | `gText_Item_Article_YarnM_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEA14` | `gText_Item_Article_YarnM_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEA48` | `gText_Item_Article_YarnL_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEA54` | `gText_Item_Article_YarnL_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEA88` | `gText_Item_Article_YarnG_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEA94` | `gText_Item_Article_YarnG_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEAC8` | `gText_Item_Article_YarnP_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEAD4` | `gText_Item_Article_YarnP_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEB08` | `gText_Item_Article_YarnX_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEB14` | `gText_Item_Article_YarnX_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEB48` | `gText_Item_Article_JunkOre_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEB54` | `gText_Item_Article_JunkOre_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEB90` | `gText_Item_Article_Copper_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEB98` | `gText_Item_Article_Copper_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEBCC` | `gText_Item_Article_Silver_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEBD4` | `gText_Item_Article_Silver_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEC08` | `gText_Item_Article_Gold_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEC10` | `gText_Item_Article_Gold_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEC40` | `gText_Item_Article_Mystrile_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEC4C` | `gText_Item_Article_Mystrile_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEC80` | `gText_Item_Article_Orichalc_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEC8C` | `gText_Item_Article_Orichalc_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EECC0` | `gText_Item_Article_Adamantite_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EECCC` | `gText_Item_Article_Adamantite_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EED00` | `gText_Item_Article_MoonStone_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EED0C` | `gText_Item_Article_MoonStone_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EED44` | `gText_Item_Article_SandRose_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EED50` | `gText_Item_Article_SandRose_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EED88` | `gText_Item_Article_PinkDiamond_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EED98` | `gText_Item_Article_PinkDiamond_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEDD0` | `gText_Item_Article_Alexandrite_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEDDC` | `gText_Item_Article_Alexandrite_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEE14` | `gText_Item_Article_MythicStone_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEE24` | `gText_Item_Article_MythicStone_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEE64` | `gText_Item_Article_Diamond_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEE6C` | `gText_Item_Article_Diamond_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEE9C` | `gText_Item_Article_Emerald_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEEA4` | `gText_Item_Article_Emerald_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEED4` | `gText_Item_Article_Ruby_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEEDC` | `gText_Item_Article_Ruby_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEF10` | `gText_Item_Article_Topaz_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEF18` | `gText_Item_Article_Topaz_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEF4C` | `gText_Item_Article_Peridot_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEF54` | `gText_Item_Article_Peridot_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEF88` | `gText_Item_Article_Fluorite_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEF94` | `gText_Item_Article_Fluorite_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEFCC` | `gText_Item_Article_Agate_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EEFD4` | `gText_Item_Article_Agate_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF008` | `gText_Item_Article_Amethyst_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF014` | `gText_Item_Article_Amethyst_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF04C` | `gText_Item_Article_HarvestGoddessJewel_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF064` | `gText_Item_Article_HarvestGoddessJewel_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF0AC` | `gText_Item_Article_KappaJewel_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF0B8` | `gText_Item_Article_KappaJewel_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF0F8` | `gText_Item_Article_JewelOfTruth_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF108` | `gText_Item_Article_JewelOfTruth_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF13C` | `gText_Item_Article_TheSpringSun_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF14C` | `gText_Item_Article_TheSpringSun_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF16C` | `gText_Item_Article_TheSummerSun_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF17C` | `gText_Item_Article_TheAutumnSun_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF18C` | `gText_Item_Article_TheWinterSun_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF19C` | `gText_Item_Article_Bracelet_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF1A8` | `gText_Item_Article_Bracelet_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF1DC` | `gText_Item_Article_Necklace_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF1E8` | `gText_Item_Article_Necklace_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF21C` | `gText_Item_Article_Earrings_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF228` | `gText_Item_Article_Earrings_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF25C` | `gText_Item_Article_Broach_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF264` | `gText_Item_Article_Broach_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF294` | `gText_Item_Article_Weeds_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF29C` | `gText_Item_Article_Weeds_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF2D0` | `gText_Item_Article_Stones_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF2D8` | `gText_Item_Article_Stones_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF31C` | `gText_Item_Article_Branches_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF328` | `gText_Item_Article_Branches_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF368` | `gText_Item_Article_Lithograph_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF374` | `gText_Item_Article_Lithograph_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF3C4` | `gText_Item_Article_MessageInABottle_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF3D8` | `gText_Item_Article_MessageInABottle_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF41C` | `gText_Item_Article_Ball_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF424` | `gText_Item_Article_Ball_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF438` | `gText_Item_Article_PirateTreasure_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF448` | `gText_Item_Article_PirateTreasure_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF488` | `gText_Item_Article_FossilOfFish_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF498` | `gText_Item_Article_FossilOfFish_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF4CC` | `gText_Item_Article_EmptyCan_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF4D8` | `gText_Item_Article_EmptyCan_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF4F0` | `gText_Item_Article_Boots_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF4F8` | `gText_Item_Article_Boots_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF50C` | `gText_Item_Article_FishBones_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF518` | `gText_Item_Article_FishBones_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF530` | `gText_Item_Article_KarensWine_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF540` | `gText_Item_Article_KarensWine_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF584` | `gText_Item_Article_PopurisMudBall_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF598` | `gText_Item_Article_PopurisMudBall_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF5CC` | `gText_Item_Article_AnnsMusicBox_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF5DC` | `gText_Item_Article_AnnsMusicBox_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF624` | `gText_Item_Article_MarysGreatBook_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF638` | `gText_Item_Article_MarysGreatBook_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF674` | `gText_Item_Article_EllisPressedFlower_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF688` | `gText_Item_Article_EllisPressedFlower_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF6D0` | `gText_Item_Article_Album1_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF6D8` | `gText_Item_Article_Album1_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF6FC` | `gText_Item_Article_Album2_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF704` | `gText_Item_Article_Album2_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF724` | `gText_Item_Article_Album3_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF72C` | `gText_Item_Article_Album3_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF750` | `gText_Item_Article_Album4_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF758` | `gText_Item_Article_Album4_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF778` | `gText_Item_Article_Album5_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF780` | `gText_Item_Article_Album5_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF7A4` | `gText_Item_Article_Album6_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF7AC` | `gText_Item_Article_Album6_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF7D0` | `gText_Item_Article_Album7_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF7D8` | `gText_Item_Article_Album7_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF7FC` | `gText_Item_Article_Album8_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF804` | `gText_Item_Article_Album8_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF828` | `gText_Item_Article_Album9_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF830` | `gText_Item_Article_Album9_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF854` | `gText_Item_Article_Album10_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF860` | `gText_Item_Article_Album10_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF880` | `gText_Item_Article_Album11_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF88C` | `gText_Item_Article_Album11_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF8D0` | `gText_Item_Article_Album12_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF8DC` | `gText_Item_Article_Album12_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF920` | `gText_Item_Article_Album13_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF92C` | `gText_Item_Article_Album13_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF970` | `gText_Item_Article_Album14_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF97C` | `gText_Item_Article_Album14_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF9C0` | `gText_Item_Article_Album15_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EF9CC` | `gText_Item_Article_Album15_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFA10` | `gText_Item_Article_Bandaid_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFA1C` | `gText_Item_Article_Bandaid_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFA50` | `gText_Item_Article_Book_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFA58` | `gText_Item_Article_Book_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFAAC` | `gText_Item_Article_Perfume_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFAB4` | `gText_Item_Article_Perfume_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFAF4` | `gText_Item_Article_Photo_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFAFC` | `gText_Item_Article_Photo_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFB38` | `gText_Item_Article_PlantEncyclopedia_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFB4C` | `gText_Item_Article_PlantEncyclopedia_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFB98` | `gText_Item_Article_Invitation_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFBA4` | `gText_Item_Article_Invitation_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFBE4` | `gText_Item_Article_Dress_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFBEC` | `gText_Item_Article_Dress_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFC28` | `gText_Item_Article_FacialPack_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFC34` | `gText_Item_Article_FacialPack_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFC74` | `gText_Item_Article_SkinLotion_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFC80` | `gText_Item_Article_SkinLotion_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFCC8` | `gText_Item_Article_Sunblock_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFCD4` | `gText_Item_Article_Sunblock_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFD08` | `gText_Item_Article_Lumber_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFD10` | `gText_Item_Article_Lumber_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFD48` | `gText_Item_Article_GoldenLumber_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFD58` | `gText_Item_Article_GoldenLumber_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFD98` | `gText_Item_Article_AnimalFodder_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFDA8` | `gText_Item_Article_AnimalFodder_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFDE8` | `gText_Item_Article_ChickenFeed_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFDF8` | `gText_Item_Article_ChickenFeed_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFE34` | `gText_Item_Article_Lottery_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFE3C` | `gText_Item_Article_Lottery_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFE94` | `gText_Item_Article_Frisbee_Name` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080EFE9C` | `gText_Item_Article_Frisbee_Description` | `data/text/us/item_2.cc` | `src/item.o(.rodata)` |
| `0x080F04EE` | `gText_Calendar_SeasonNames` | `data/text/us/game_state.cc` | `src/game_state.o(.rodata)` |
| `0x080F050C` | `gText_Calendar_None` | `data/text/us/game_state.cc` | `src/game_state.o(.rodata)` |
| `0x080F050F` | `gText_Calendar_WeekdayNames` | `data/text/us/game_state.cc` | `src/game_state.o(.rodata)` |
...
| `0x080F0580` | `gCppRuntimeBadAlloc_GameState` | `data/text/us/game_state_1.cc` | `src/game_state.o(.rodata)` |
...
| `0x080F0654` | `gText_AnimalMemorial_LineBreak` | `data/text/us/animal_data.cc` | `src/animal_data.o(.rodata)` |
| `0x080F0658` | `gText_AnimalMemorial_Continue` | `data/text/us/animal_data.cc` | `src/animal_data.o(.rodata)` |
| `0x080F065C` | `gText_AnimalMemorial_PageBreak` | `data/text/us/animal_data.cc` | `src/animal_data.o(.rodata)` |
| `0x080F0660` | `gText_AnimalMemorial_Header` | `data/text/us/animal_data.cc` | `src/animal_data.o(.rodata)` |
| `0x080F067C` | `gText_AnimalMemorial_FarmPrefix` | `data/text/us/animal_data.cc` | `src/animal_data.o(.rodata)` |
| `0x080F0684` | `gText_AnimalMemorial_FarmSuffix` | `data/text/us/animal_data.cc` | `src/animal_data.o(.rodata)` |
| `0x080F068C` | `gText_AnimalMemorial_PassedAway` | `data/text/us/animal_data.cc` | `src/animal_data.o(.rodata)` |
| `0x080F069C` | `gText_AnimalMemorial_NamesIntro` | `data/text/us/animal_data.cc` | `src/animal_data.o(.rodata)` |
| `0x080F06B4` | `gText_AnimalMemorial_PrayerIntro` | `data/text/us/animal_data.cc` | `src/animal_data.o(.rodata)` |
| `0x080F06D0` | `gText_AnimalMemorial_PrayerEnding` | `data/text/us/animal_data.cc` | `src/animal_data.o(.rodata)` |
...
| `0x080F1980` | `gText_EmptyUiLabel` | `data/text/us/common_ui.cc` | `src/common_ui.o(.rodata)` |
...
| `0x080FB284` | `gText_IntroScene_FatherFishingInvitation` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB2D0` | `gText_IntroScene_MotherCannotFindPlayer` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB2F4` | `gText_IntroScene_PlayerResponseWhat` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB300` | `gText_IntroScene_OldManName` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB308` | `gText_IntroScene_OldManFindsPlayer` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB398` | `gText_IntroScene_MotherThanksOldMan` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB3CC` | `gText_IntroScene_FatherExplainsVacation` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB420` | `gText_IntroScene_OldManOffersStay` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB46C` | `gText_IntroScene_FatherAsksAboutStay` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB484` | `gText_IntroScene_OldManWelcomesFamily` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB4D4` | `gText_IntroScene_MotherTellsPlayerToPlay` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB51C` | `gText_IntroScene_UnknownName` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB520` | `gText_IntroScene_UnknownCallsPlayer` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB534` | `gText_IntroScene_UnknownFindsPlayer` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB53C` | `gText_IntroScene_GirlName` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB544` | `gText_IntroScene_GirlThinksPlayerDead` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB578` | `gText_IntroScene_GirlInvitesPlayerToPlay` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB5D4` | `gText_IntroScene_GirlAsksPlayerStory` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB634` | `gText_IntroScene_OldManFarewell` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB6C0` | `gText_IntroScene_OldManRequestsLetter` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB710` | `gText_IntroScene_OldManGivesAddress` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB738` | `gText_IntroScene_GirlSaysGoodbye` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB754` | `gText_IntroScene_GirlAsksPlayerToReturn` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB7A0` | `gText_IntroScene_OldManNotesFriend` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
| `0x080FB7F0` | `gText_IntroScene_OldManWaitsForLetter` | `data/text/us/intro_scene_data_1.cc` | `src/intro_scene_data.o(.rodata)` |
...
| `0x080FEAF4` | `gText_BeachCafeShop_WaterDescription` | `data/text/us/beach_cafe_shop_data.cc` | `src/beach_cafe_shop_data.o(.rodata)` |
| `0x080FEB14` | `gText_BeachCafeShop_EmptyDescription` | `data/text/us/beach_cafe_shop_data.cc` | `src/beach_cafe_shop_data.o(.rodata)` |
| `0x080FEB18` | `gText_BeachCafeShop_SpaghettiDescription` | `data/text/us/beach_cafe_shop_data.cc` | `src/beach_cafe_shop_data.o(.rodata)` |
| `0x080FEB3C` | `gText_BeachCafeShop_SnowConeDescription` | `data/text/us/beach_cafe_shop_data.cc` | `src/beach_cafe_shop_data.o(.rodata)` |
| `0x080FEBEC` | `gText_BeachCafeShop_InsufficientGold` | `data/text/us/beach_cafe_shop_data_1.cc` | `src/beach_cafe_shop_data.o(.rodata)` |
| `0x080FEC14` | `gText_BeachCafeShop_NoOrder` | `data/text/us/beach_cafe_shop_data_1.cc` | `src/beach_cafe_shop_data.o(.rodata)` |
| `0x080FEC44` | `gText_BeachCafeShop_OrderComplete` | `data/text/us/beach_cafe_shop_data_1.cc` | `src/beach_cafe_shop_data.o(.rodata)` |
...
| `0x081037B4` | `gText_FishingRecord_MessageBottle` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081037C4` | `gText_FishingRecord_EmptyCan` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081037D0` | `gText_FishingRecord_Branch` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081037D8` | `gText_FishingRecord_FishBones` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081037E4` | `gText_FishingRecord_Boots` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081037EC` | `gText_FishingRecord_RockTrout` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081037F8` | `gText_FishingRecord_Scad` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103800` | `gText_FishingRecord_Fatminnow` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x0810380C` | `gText_FishingRecord_CherrySalmon` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x0810381C` | `gText_FishingRecord_Pigfish` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103824` | `gText_FishingRecord_Sardine` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x0810382C` | `gText_FishingRecord_MountainTrout` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x0810383C` | `gText_FishingRecord_Whitefish` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103848` | `gText_FishingRecord_Eel` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x0810384C` | `gText_FishingRecord_Bitterling` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103858` | `gText_FishingRecord_Bonito` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103860` | `gText_FishingRecord_Fluke` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103868` | `gText_FishingRecord_Filefish` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103874` | `gText_FishingRecord_GoldenCarp` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103880` | `gText_FishingRecord_SilverCarp22` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x0810388C` | `gText_FishingRecord_KelpBass` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103898` | `gText_FishingRecord_Bighead` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081038A0` | `gText_FishingRecord_Salmon` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081038A8` | `gText_FishingRecord_Mackerel` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081038B4` | `gText_FishingRecord_Needlefish` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081038C0` | `gText_FishingRecord_SpanishMackerel` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081038D0` | `gText_FishingRecord_SauryPike` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081038DC` | `gText_FishingRecord_Dorado` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081038E4` | `gText_FishingRecord_RedSnapper` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081038F0` | `gText_FishingRecord_Cod` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081038F4` | `gText_FishingRecord_Roach` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081038FC` | `gText_FishingRecord_BrownHakeling` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x0810390C` | `gText_FishingRecord_RainbowTrout` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x0810391C` | `gText_FishingRecord_Herring` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103924` | `gText_FishingRecord_Sandfish` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103930` | `gText_FishingRecord_Flounder` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x0810393C` | `gText_FishingRecord_Blowfish` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103948` | `gText_FishingRecord_BlackBass` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103954` | `gText_FishingRecord_Yellowtail` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103960` | `gText_FishingRecord_Bluegill` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x0810396C` | `gText_FishingRecord_CrucianCarp` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x0810397C` | `gText_FishingRecord_Greenling` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103988` | `gText_FishingRecord_Tuna` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x08103990` | `gText_FishingRecord_OceanSunfish` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081039A0` | `gText_FishingRecord_Lionfish` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081039AC` | `gText_FishingRecord_Rockfish` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081039B8` | `gText_FishingRecord_LargeSalmon` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081039C4` | `gText_FishingRecord_Snakehead` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081039D0` | `gText_FishingRecord_LakeSmelt` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081039DC` | `gText_FishingRecord_JapaneseHuchen` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081039E8` | `gText_FishingRecord_Monkfish` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
| `0x081039F4` | `gText_FishingRecord_Catfish` | `data/text/us/fishing_results_data.cc` | `src/fishing_results_data.o(.rodata)` |
