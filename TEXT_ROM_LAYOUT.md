...
| DE | `0x08108FD8`–`0x08109CDF` | `src/reference_guide.o(.rodata.reference_guide)` | `src/reference_guide.cc` 与 `data/text/de/reference_guide/harvest_sprite_minigames.cc` | 精确 |
